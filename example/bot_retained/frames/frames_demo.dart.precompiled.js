...
Interceptor: {"": "Object;",
  ...
  "%": "CanvasGradient|CanvasPattern|CanvasRenderingContext|CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|SVGAnimatedTransformList"
},
...
AffineTransform: {"": "Object;_scX<,_shY,_shX,_scY,_tX,_tY",
  ...
  concatenate$1: function(tx) {
    ...
    if (typeof t1 !== "number")
      throw t1.$mul();
    this._tY = J.$add$ns(t3, t2 * m0 + t1 * m1);
    return this;
  },
...
Coordinate: {"": "Point;x,y",
  $add: function(_, other) {
    ...
    if (typeof t2 !== "number")
      throw H.iae(t2);
    t3 = J.$add$ns(this.y, other.y);
    t3 = new X.Coordinate(t1 + t2, t3);
    H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(this, "Coordinate", 0)]);
    return t3;
  },
  $asPoint: null,
  static: {
...
TxThing: {"": "ParentThing;_sourceSize,_canvasThing,_shape,_positionShape,_rotateScaleShape,_tx,_rotateScaleCoordinate,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  get$_dragPosition: function() {
    return new H.BoundClosure$1(this, O.TxThing.prototype._dragPosition$1, null, "_dragPosition$1");
  },
  ...
  get$_dragRotateScale: function() {
    return new H.BoundClosure$1(this, O.TxThing.prototype._dragRotateScale$1, null, "_dragRotateScale$1");
  },
