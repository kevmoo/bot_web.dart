...
AffineTransform: {"": "Object;_scX<,_shY<,_shX<,_scY<,_tX<,_tY<",
  ...
  transformCoordinate$1: function(point) {
    ...
    if (typeof t4 !== "number")
      throw H.iae(t4);
    t4 = new X.Coordinate(t1 * t2 + t5 + t6, t1 * t7 + t3 + t4);
...
Coordinate: {"": "Point;x,y",
  ...
  $add: function(_, other) {
    ...
    if (typeof t3 !== "number")
      throw H.iae(t3);
    t2 = J.$add$ns(this.y, t2.get$y(other));
    t2 = new X.Coordinate(t1 + t3, t2);
...
Coordinate_difference: function(a, b) {
  ...
  if (typeof t3 !== "number")
    throw H.iae(t3);
  t2 = new X.Vector(t1 - t3, J.$sub$n(a.y, t2.get$y(b)));
...
Vector: {"": "Coordinate;x,y",
  ...
  scale$1: function(_, magnitude) {
    ...
    t2 = new X.Vector(t1 * magnitude, t2);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(this, "Vector", 0)]);
    return t2;
  },
  $asCoordinate: null,
...
CanvasThing: {"": "PanelThing;_children,background,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  setCenter$2: function(thing, value) {
    ...
    if (typeof t2 !== "number")
      throw t2.$div();
    sizeOffset = new X.Vector(t1 / 2, t2 / 2);
    H.setRuntimeTypeInfo(sizeOffset, [null]);
    this.setTopLeft$2(thing, X.Coordinate_difference(value, sizeOffset));
  },
  $isCanvasThing: true
},
...
Point: {"": "Object;x>,y>",
  ...
  $sub: function(_, other) {
    ...
    if (typeof t3 !== "number")
      throw H.iae(t3);
    t2 = J.$sub$n(this.y, t2.get$y(other));
    t2 = new P.Point(t1 - t3, t2);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(this, "Point", 0)]);
    return t2;
  },
...
TxThing: {"": "ParentThing;_sourceSize,_canvasThing,_shape,_positionShape,_rotateScaleShape,_tx,_rotateScaleCoordinate,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  _updateRotateScale$0: function() {
    var t1 = new X.Coordinate(0, this._sourceSize.height);
    H.setRuntimeTypeInfo(t1, [null]);
    this._rotateScaleCoordinate = this._tx.transformCoordinate$1(t1);
  ...
  _dragRotateScale$1: function(e) {
    ...
    t2 = pointDeltaVector.get$magnitude();
