...
Coordinate_difference: function(a, b) {
  ...
  return $.Vector$($.$sub$n(t1.get$x(a), t2.get$x(b)), $.$sub$n(t1.get$y(a), t2.get$y(b)));
},
...
_ZoneBase: {"": "Object;",
  ...
  _checkIfDone$0: function() {
    if (!this._isExecutingCallback && this._openCallbacks === 0 && $.JSArray_methods.get$isEmpty(this._liblib1$_children))
      this._dispose$0();
  },
...
_EventStreamSubscription: {"": "StreamSubscription;_pauseCount,_liblib3$_target,_eventType,_onData,_useCapture",
  cancel$0: function() {
    if (this.get$_liblib3$_canceled())
      return;
    this._unlisten$0();
    this._liblib3$_target = null;
    this._onData = null;
  },
  get$_liblib3$_canceled: function() {
...
TxThing: {"": "ParentThing;_sourceSize,_canvasThing,_shape,_positionShape,_rotateScaleShape,_tx,_rotateScaleCoordinate,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  _dragPosition$1: function(e) {
    ...
    this._tx.updateValues$2$translateX$translateY(newValue.x, newValue.y);
  ...
  _dragRotateScale$1: function(e) {
    var pc, pointDeltaVector, t1, t2, newScale, angle;
    ...
    t1 = $.get$length$asx(pointDeltaVector);
    t2 = this._sourceSize.height;
    if (typeof t2 !== "number")
      throw $.iae(t2);
    newScale = t1 / t2;
    angle = $.Vector_0_10.getAngle$1(pointDeltaVector);
    t2 = this._tx;
    t2.setToTranslation$2(pc.x, pc.y);
    t2.rotate$3(t2, angle, 0, 0);
    t2.scale$2(t2, newScale, newScale);
    this._updatePoints$0();
  },
...
FrameDemo_FrameDemo: function(canvas) {
  ...
  return $.FrameDemo$_internal(canvas, $.CanvasThing$(t1.get$width(canvas), t1.get$height(canvas)));
},
...
TxThing$_internal: function(width, height, _sourceSize, _shape, _tx) {
  var t1 = new $.TxThing(_sourceSize, $.CanvasThing$(width, height), _shape, $.ShapeThing$(20, 20, "gray", $.ShapeType_Rect), $.ShapeThing$(20, 20, "red", $.ShapeType_Rect), _tx, null, $.List_List(null), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
