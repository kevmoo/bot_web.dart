...
$$.TxThing = {"": "ParentThing;_sourceSize,_canvasThing,_shape,_positionShape,_rotateScaleShape,_tx,_rotateScaleCoordinate,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  _dragRotateScale$1: function(e) {
    var t1, pc, pointDeltaVector, t2, newScale, angle;
    ...
    t2 = this._canvasThing;
    t2.setCenter$2(this._positionShape, this.get$_positionCoordinate());
    t2.setCenter$2(this._rotateScaleShape, this._rotateScaleCoordinate);
  },
...
$$.AttachableObject = {"": "DisposableImpl;",
  ...
  _liblib0$_onCancel$1: function(property) {
    var t1, handle;
  ...
  _liblib0$_set$2: function(key, value) {
    var t1;
    if (this._disposed)
      $.throwExpression($.DisposedError_SMD);
...
$$.AttachableObject__getStream__anon = {"": "Closure;this_2,property_3",
  call$0: function() {
    return this.this_2._liblib0$_onCancel$1(this.property_3);
  }
};
...
$$.Property = {"": "Attachable;defaultValue,name",
  ...
  set$2: function(obj, value) {
    obj._liblib0$_set$2(this, value);
  },
...
$.main = function() {
  ...
  $.FrameDemo$_internal(canvas, $.CanvasThing$(t1.get$width(canvas), t1.get$height(canvas))).requestFrame$0();
};
