...
Coordinate_difference: function(a, b) {
  ...
  if (typeof t4 !== "number")
    throw H.iae(t4);
  return new X.Vector(t1 - t2, t3 - t4);
}}
...
CanvasThing: {"": "PanelThing;_children,background,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  setCenter$2: function(thing, value) {
    this.setTopLeft$2(thing, X.Coordinate_difference(value, new X.Vector(thing._width / 2, thing._height / 2)));
  },
  $isCanvasThing: true
},
...
MouseManager: {"": "Object;_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  ...
  MouseManager$_internal$1: function(_stage) {
    ...
    t4 = new W._EventStreamSubscription(0, t2._liblib$_target, t2._eventType, W._EventStreamSubscription__wrapZone(t4), t2._useCapture);
    ...
    t2 = new W._EventStreamSubscription(0, t4._liblib$_target, t4._eventType, W._EventStreamSubscription__wrapZone(t2), t4._useCapture);
    ...
    t5 = new W._EventStreamSubscription(0, t2._liblib$_target, t2._eventType, W._EventStreamSubscription__wrapZone(t5), t2._useCapture);
    ...
    t5 = new W._EventStreamSubscription(0, t1._liblib$_target, t1._eventType, W._EventStreamSubscription__wrapZone(t5), t1._useCapture);
    ...
    t5 = new W._EventStreamSubscription(0, t3._liblib$_target, t3._eventType, W._EventStreamSubscription__wrapZone(t5), t3._useCapture);
    ...
    t5 = new W._EventStreamSubscription(0, t4._liblib$_target, t4._eventType, W._EventStreamSubscription__wrapZone(t5), t4._useCapture);
    ...
    t4 = new W._EventStreamSubscription(0, t5._liblib$_target, t5._eventType, W._EventStreamSubscription__wrapZone(t4), t5._useCapture);
...
["click_demo.dart", "click_demo.dart", , X, {
main: function() {
  X.ClickDemo_ClickDemo(document.querySelector("#content")).requestFrame$0();
},
...
ClickDemo_ClickDemo: function(canvas) {
  var t1, t2, pCanvas, blue, green, red, t3, t4, t5, rootPanel;
  ...
  pCanvas = new B.CanvasThing(t1, null, t2, new X.EventHandle(P.StreamController_StreamController$broadcast(null, null, true, null), false), null, 200, 200, 1, false, null, null, P.LinkedHashMap_LinkedHashMap(null, null, null, X.Property, P.Object), P.LinkedHashMap_LinkedHashMap(null, null, null, X.Attachable, X.EventHandle), false);
  pCanvas.background = "yellow";
  t2 = P.List_List(null, X.AffineTransform);
  H.setRuntimeTypeInfo(t2, [X.AffineTransform]);
  blue = new B.ShapeThing("blue", C.ShapeType_Rect, t2, new X.EventHandle(P.StreamController_StreamController$broadcast(null, null, true, null), false), null, 100, 100, 1, false, null, null, P.LinkedHashMap_LinkedHashMap(null, null, null, X.Property, P.Object), P.LinkedHashMap_LinkedHashMap(null, null, null, X.Attachable, X.EventHandle), false);
  B.MouseManager__setBoolProp(blue, $.get$MouseManager__isClickableProperty(), true);
  t2 = $.get$MouseManager__clickEvent();
  t2.getStream$1;
  blue._getStream$1(t2).listen$1(new X.ClickDemo_ClickDemo_closure(blue));
  t2 = pCanvas._children;
  pCanvas.insertAt$2(blue, t2.length);
  t1 = P.List_List(null, X.AffineTransform);
  H.setRuntimeTypeInfo(t1, [X.AffineTransform]);
  green = new B.ShapeThing("green", C.ShapeType_Rect, t1, new X.EventHandle(P.StreamController_StreamController$broadcast(null, null, true, null), false), null, 70, 70, 1, false, null, null, P.LinkedHashMap_LinkedHashMap(null, null, null, X.Property, P.Object), P.LinkedHashMap_LinkedHashMap(null, null, null, X.Attachable, X.EventHandle), false);
  pCanvas.insertAt$2(green, t2.length);
  pCanvas.setTopLeft$2(green, C.Coordinate_110_15);
  t1 = P.List_List(null, X.AffineTransform);
  H.setRuntimeTypeInfo(t1, [X.AffineTransform]);
  red = new B.ShapeThing("red", C.ShapeType_Ellipse, t1, new X.EventHandle(P.StreamController_StreamController$broadcast(null, null, true, null), false), null, 40, 40, 1, false, null, null, P.LinkedHashMap_LinkedHashMap(null, null, null, X.Property, P.Object), P.LinkedHashMap_LinkedHashMap(null, null, null, X.Attachable, X.EventHandle), false);
  pCanvas.insertAt$2(red, t2.length);
  pCanvas.setCenter$2(red, C.Coordinate_50_150);
  B.MouseManager__setBoolProp(red, $.get$MouseManager__isClickableProperty(), true);
  t2 = $.get$MouseManager__mouseUpEvent();
  t2.getStream$1;
  red._getStream$1(t2).listen$1(new X.ClickDemo_ClickDemo_closure0());
  t2 = $.get$MouseManager__mouseDownEvent();
  t2.getStream$1;
  red._getStream$1(t2).listen$1(new X.ClickDemo_ClickDemo_closure1());
  t2 = pCanvas.addTransform$0();
  t1 = J.getInterceptor$x(canvas);
  t3 = t1.get$width(canvas);
  t4 = pCanvas._width;
  if (typeof t3 !== "number")
    throw t3.$sub();
  ...
  if (typeof t1 !== "number")
    throw t1.$sub();
  t2.translate$2(t2, (t3 - t4) / 2, (t1 - t5) / 2);
  t5 = P.List_List(null, B.Thing);
  H.setRuntimeTypeInfo(t5, [B.Thing]);
  t1 = P.List_List(null, X.AffineTransform);
  H.setRuntimeTypeInfo(t1, [X.AffineTransform]);
  rootPanel = new B.CanvasThing(t5, null, t1, new X.EventHandle(P.StreamController_StreamController$broadcast(null, null, true, null), false), null, 500, 500, 1, false, null, null, P.LinkedHashMap_LinkedHashMap(null, null, null, X.Property, P.Object), P.LinkedHashMap_LinkedHashMap(null, null, null, X.Attachable, X.EventHandle), false);
  rootPanel.insertAt$2(pCanvas, rootPanel._children.length);
  t1 = new B.Stage(new X.EventHandle(P.StreamController_StreamController$broadcast(null, null, true, null), false), canvas, rootPanel, null, P.LinkedHashMap_LinkedHashMap(null, null, null, X.Property, P.Object), P.LinkedHashMap_LinkedHashMap(null, null, null, X.Attachable, X.EventHandle), false);
  t1.rootThing.registerParent$1(t1);
  t1 = new X.ClickDemo(canvas, t1, rootPanel, null, false, false);
  t1.StageWrapper$2(canvas, rootPanel);
  B.MouseManager_MouseManager(t1.stage);
  return t1;
}}
},
...
ClickDemo_ClickDemo_closure: {"": "Closure;blue_0",
  call$1: function(args) {
    var t1 = this.blue_0;
    t1._fillStyle = t1._fillStyle === "blue" ? "lightblue" : "blue";
    t1.invalidateDraw$0();
  }
},
...
ClickDemo_ClickDemo_closure0: {"": "Closure;",
  call$1: function(args) {
    H.Primitives_printString(C.JSArray_methods.toString$0(["up", args]));
    return;
  }
},
...
ClickDemo_ClickDemo_closure1: {"": "Closure;",
  call$1: function(args) {
    H.Primitives_printString(C.JSArray_methods.toString$0(["down", args]));
    return;
  }
}},
1],
...
_BroadcastSubscription: {"": "_ControllerSubscription;_eventState@,_liblib2$_next@,_liblib2$_previous?,_liblib2$_controller,_liblib2$_onData,_onError,_onDone,_zone,_state,_pending",
...
_BroadcastStreamController: {"": "Object;_liblib2$_next@,_liblib2$_previous?",
  ...
  get$hasListener: function() {
    return this._liblib2$_next !== this;
  },
...
_SyncBroadcastStreamController: {"": "_BroadcastStreamController;_onListen,_onCancel,_state,_liblib2$_next,_liblib2$_previous,_addStreamState,_doneFuture",
...
_AsyncBroadcastStreamController: {"": "_BroadcastStreamController;_onListen,_onCancel,_state,_liblib2$_next,_liblib2$_previous,_addStreamState,_doneFuture",
  _sendData$1: function(data) {
    var link;
  ...
  _sendDone$0: function() {
    var link = this._liblib2$_next;
    if (link !== this)
      for (; link !== this; link = link.get$_liblib2$_next())
...
_ControllerStream: {"": "_StreamImpl;",
  ...
  get$hashCode: function(_) {
    return (H.Primitives_objectHashCode(this._liblib2$_controller) ^ 892482866) >>> 0;
  },
  $eq: function(_, other) {
    var t1;
    if (other == null)
...
_CustomizedZone: {"": "Object;parent>,_specification<,_liblib2$_map",
...
_EventStream: {"": "Stream;_liblib$_target,_eventType,_useCapture",
  listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
    var t1 = new W._EventStreamSubscription(0, this._liblib$_target, this._eventType, W._EventStreamSubscription__wrapZone(onData), this._useCapture);
...
_ElementEventStreamImpl: {"": "_EventStream;_liblib$_target,_eventType,_useCapture", $as_EventStream: null},
...
_EventStreamSubscription: {"": "StreamSubscription;_pauseCount,_liblib$_target,_eventType,_onData,_useCapture",
  ...
  _tryResume$0: function() {
    ...
    if (t1 != null && this._pauseCount <= 0)
      J.$$dom_addEventListener$3$x(this._liblib$_target, this._eventType, t1, this._useCapture);
  },
  _unlisten$0: function() {
    var t1 = this._onData;
    if (t1 != null)
      J.$$dom_removeEventListener$3$x(this._liblib$_target, this._eventType, t1, this._useCapture);
  },
...
Point: {"": "Object;x>,y>",
  ...
  $sub: function(_, other) {
    ...
    if (typeof t4 !== "number")
      throw H.iae(t4);
    return new W.Point(t1 - t2, t3 - t4);
  },
  $isPoint: true
},
...
C.Coordinate_110_15 = new X.Coordinate(110, 15);
C.Coordinate_50_150 = new X.Coordinate(50, 150);
...
function dart_precompiled($collectedClasses) {
  ...
  function ClickDemo(canvas, stage, rootThing, _invalidatedEventSub, _frameRequested, _disposed) {
    this.canvas = canvas;
    this.stage = stage;
    this.rootThing = rootThing;
  ...
  ClickDemo.builtin$cls = "ClickDemo";
  if (!"name" in ClickDemo)
    ClickDemo.name = "ClickDemo";
  $desc = $collectedClasses.ClickDemo;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ClickDemo.prototype = $desc;
  function ClickDemo_ClickDemo_closure(blue_0) {
    this.blue_0 = blue_0;
  }
  ClickDemo_ClickDemo_closure.builtin$cls = "ClickDemo_ClickDemo_closure";
  if (!"name" in ClickDemo_ClickDemo_closure)
    ClickDemo_ClickDemo_closure.name = "ClickDemo_ClickDemo_closure";
  $desc = $collectedClasses.ClickDemo_ClickDemo_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ClickDemo_ClickDemo_closure.prototype = $desc;
  function ClickDemo_ClickDemo_closure0() {
  }
  ClickDemo_ClickDemo_closure0.builtin$cls = "ClickDemo_ClickDemo_closure0";
  if (!"name" in ClickDemo_ClickDemo_closure0)
    ClickDemo_ClickDemo_closure0.name = "ClickDemo_ClickDemo_closure0";
  $desc = $collectedClasses.ClickDemo_ClickDemo_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ClickDemo_ClickDemo_closure0.prototype = $desc;
  function ClickDemo_ClickDemo_closure1() {
  }
  ClickDemo_ClickDemo_closure1.builtin$cls = "ClickDemo_ClickDemo_closure1";
  if (!"name" in ClickDemo_ClickDemo_closure1)
    ClickDemo_ClickDemo_closure1.name = "ClickDemo_ClickDemo_closure1";
  $desc = $collectedClasses.ClickDemo_ClickDemo_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ClickDemo_ClickDemo_closure1.prototype = $desc;
  ...
  function _BroadcastStream(_liblib2$_controller) {
    this._liblib2$_controller = _liblib2$_controller;
  }
  ...
  function _BroadcastSubscription(_eventState, _liblib2$_next, _liblib2$_previous, _liblib2$_controller, _liblib2$_onData, _onError, _onDone, _zone, _state, _pending) {
  ...
  function _SyncBroadcastStreamController(_onListen, _onCancel, _state, _liblib2$_next, _liblib2$_previous, _addStreamState, _doneFuture) {
  ...
  function _AsyncBroadcastStreamController(_onListen, _onCancel, _state, _liblib2$_next, _liblib2$_previous, _addStreamState, _doneFuture) {
    this._onListen = _onListen;
    this._onCancel = _onCancel;
    this._state = _state;
    this._liblib2$_next = _liblib2$_next;
  ...
  function _ControllerSubscription(_liblib2$_controller) {
    this._liblib2$_controller = _liblib2$_controller;
  }
  ...
  _ControllerSubscription.prototype.get$_liblib2$_controller = function() {
    return this._liblib2$_controller;
  };
  ...
  function _CustomizedZone(parent, _specification, _liblib2$_map) {
    this.parent = parent;
  ...
  function _EventStream(_liblib$_target, _eventType, _useCapture) {
  ...
  function _ElementEventStreamImpl(_liblib$_target, _eventType, _useCapture) {
    this._liblib$_target = _liblib$_target;
    this._eventType = _eventType;
    this._useCapture = _useCapture;
  }
  ...
  function _EventStreamSubscription(_pauseCount, _liblib$_target, _eventType, _onData, _useCapture) {
