...
AffineTransform: {"": "Object;_scX<,_shY<,_shX<,_scY<,_tX<,_tY<",
  ...
  transformCoordinate$1: function(point) {
    ...
    return new $.Coordinate($.$add$ns($.$add$ns($.$mul$n(t1.get$x(point), this._scX), $.$mul$n(t1.get$y(point), this._shX)), this._tX), $.$add$ns($.$add$ns($.$mul$n(t1.get$x(point), this._shY), $.$mul$n(t1.get$y(point), this._scY)), this._tY));
  },
...
Box: {"": "Object;left>,top>,width>,height>",
  ...
  getCorners$0: function() {
    ...
    if (typeof t4 !== "number")
      throw $.iae(t4);
    t4 = t2 + t4;
    return [new $.Coordinate(t1, t2), new $.Coordinate(t3, t2), new $.Coordinate(t3, t4), new $.Coordinate(t1, t4)];
  },
  $eq: function(_, other) {
    var t1, t2;
    t1 = other == null;
...
RetainedDebug_borderHitTest: function(stage, point) {
  ...
  if ($.$gt$n(t1.get$length(hits), 0)) {
    ctx.save();
    ctx.lineWidth = 2;
    t1.forEach$1(hits, new $.RetainedDebug_borderHitTest_closure(ctx));
    ctx.restore();
  }
},
...
RetainedDebug__borderThingCore: function(ctx, thing) {
  ...
  ctx.beginPath();
  t1 = $.getInterceptor$asx(corners);
  ctx.moveTo($.get$x$x(t1.$index(corners, 3)), $.get$y$x(t1.$index(corners, 3)));
...
RetainedUtil_getCorners: function(thing) {
  ...
  t1 = new $.MappedListIterable(new $.Box(0, 0, t1.get$width(thing), t1.get$height(thing)).getCorners$0(), new $.RetainedUtil_getCorners_closure(thing));
...
_ZoneBase: {"": "Object;",
  ...
  _checkIfDone$0: function() {
    if (!this._isExecutingCallback && this._openCallbacks === 0 && this._liblib3$_children.length === 0)
      ;
  },
...
_DefaultZone: {"": "_ZoneBase;_parentZone,_liblib3$_children,_openCallbacks,_isExecutingCallback",
  get$_errorZone: function() {
    return this;
  },
  handleUncaughtError$1: function(error) {
...
SpinDemo: {"": "StageWrapper;_tx,_mouseLocation,canvas,stage,rootThing,_invalidatedEventSub,_frameRequested,_disposed",
  drawFrame$1: function(highResTime) {
    var t1;
    this._tx.concatenate$1($.AffineTransform$(1, 0, 0, 1, 0, 0).setToRotation$3(0.031415926535897934, 100, 100));
  ...
  _canvas_mouseMove$1: function(e) {
    var t1 = $.get$offset$x(e);
    this._mouseLocation = new $.Coordinate(t1.get$x(t1), t1.get$y(t1));
  },
  get$_canvas_mouseMove: function() {
    return new $.BoundClosure$1(this, "_canvas_mouseMove$1", null);
  },
  _canvas_mouseOut$1: function(e) {
    this._mouseLocation = null;
  },
  get$_canvas_mouseOut: function() {
    return new $.BoundClosure$1(this, "_canvas_mouseOut$1", null);
  },
  SpinDemo$_internal$3: function(canvas, thing, _tx) {
    ...
    new $._EventStreamSubscription(0, t1._liblib0$_target, t1._eventType, this.get$_canvas_mouseMove(), t1._useCapture)._tryResume$0();
    canvas.get$onMouseOut;
    $.EventStreamProvider_mouseout.forTarget$2$useCapture;
    t1 = new $._EventStream(canvas, $.EventStreamProvider_mouseout._eventType, false);
    new $._EventStreamSubscription(0, t1._liblib0$_target, t1._eventType, this.get$_canvas_mouseOut(), t1._useCapture)._tryResume$0();
  },
  static: {
SpinDemo_SpinDemo: function(canvas) {
  var pCanvas, green, red, t1, t2, t3, tx, rootPanel;
  ...
  pCanvas.insertAt$2(new $.ShapeThing("blue", $.ShapeType_Rect, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, 100, 100, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false), t1.length);
  pCanvas.insertAt$2(green, t1.length);
  pCanvas.setTopLeft$2(green, new $.Coordinate(15, 15));
  pCanvas.insertAt$2(red, t1.length);
  pCanvas.setCenter$2(red, new $.Coordinate(50, 50));
...
SpinDemo$_internal: function(canvas, thing, _tx) {
  var t1 = new $.Stage(new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), canvas, thing, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  t1.rootThing.registerParent$1(t1);
  t1 = new $.SpinDemo(_tx, null, canvas, t1, thing, null, false, false);
