...
Box: {"": "Object;left>,top>,width>,height>",
  ...
  getCorners$0: function() {
    ...
    if (typeof t6 !== "number")
      throw $.iae(t6);
    t6 = t2 + t6;
    return [t3, t5, $.Coordinate$(t4, t6), $.Coordinate$(t1, t6)];
  },
  $eq: function(_, other) {
    var t1, t2;
    t1 = other == null;
...
Mouse_isMouseOver: function(thing) {
  return $.get$Mouse_isMouseOverProperty().get$1(thing);
},
...
RetainedDebug_borderHitTest: function(stage, point) {
  var ctx, hits, t1;
  ctx = stage.get$ctx();
  hits = $.RetainedUtil_hitTest(stage, point);
...
RetainedDebug__borderThingCore: function(ctx, thing) {
  var corners, t1, p, t2;
  if ($.Mouse_isMouseDirectlyOver(thing) === true)
    ctx.strokeStyle = "red";
  else if ($.Mouse_isMouseOver(thing) === true)
...
RetainedUtil_getCorners: function(thing) {
  ...
  t1 = $.JSArray_methods.map$1($.Box$(0, 0, t1.get$width(thing), t1.get$height(thing)).getCorners$0(), new $.RetainedUtil_getCorners_closure(thing));
...
_BroadcastSubscription: {"": "_ControllerSubscription;_eventState@,_liblib1$_next@,_liblib1$_previous@,_liblib1$_controller,_liblib1$_onData,_onError,_onDone,_zone,_state,_pending",
  ...
  _BroadcastSubscription$5: function(controller, onData, onError, onDone, cancelOnError) {
    this._liblib1$_previous = this;
    this._liblib1$_next = this;
  }
},
...
SpinDemo_SpinDemo: function(canvas) {
  var pCanvas, blue, green, red, t1, t2, t3, tx, rootPanel;
