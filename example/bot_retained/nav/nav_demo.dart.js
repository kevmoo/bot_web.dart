...
$$.NavDemo = {"": "StageWrapper;_count,canvas,stage,rootThing,_invalidatedEventSub,_frameRequested,_disposed",
  ...
  _itemClick$1: function(element) {
    var t1, tx, lastTx, t2;
    if ($.$eq($.get$width$x(element), 300) === true) {
      t1 = $.AffineTransform$(1, 0, 0, 1, 100, 100);
      t1._scX = $.$mul$n(t1._scX, 0.3333333333333333);
      t1._shY = $.$mul$n(t1._shY, 0.3333333333333333);
      t1._shX = $.$mul$n(t1._shX, 0.3333333333333333);
      t1._scY = $.$mul$n(t1._scY, 0.3333333333333333);
      tx = t1.createInverse$0();
    } else {
      lastTx = element.getTransform$0();
      tx = $.AffineTransform$(1, 0, 0, 1, lastTx.get$translateX(), lastTx.get$translateY());
      tx._scX = $.$mul$n(tx._scX, 0.3333333333333333);
      tx._shY = $.$mul$n(tx._shY, 0.3333333333333333);
      tx._shX = $.$mul$n(tx._shX, 0.3333333333333333);
      tx._scY = $.$mul$n(tx._scY, 0.3333333333333333);
    }
    t1 = this.rootThing;
    if (t1.get$canForward()) {
      t2 = this._count + 1;
...
$$.StreamController = {"": "EventSink;stream>",
  add$1: function(_, value) {
    return this.get$stream(this)._liblib1$_add$1(value);
  }
};
...
$$.NavThing = {"": "ParentThing;verticalAlignment,horizontalAlignment,_child,_txPanel,_childOffset,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  forward$3: function(thing, tx, frameCount) {
    var t1, message, existingTx, t2, tempCanvas, tempCtx;
    if (false)
      $.throwExpression($.InvalidOperationError$("That's just sad. Give me a good argName"));
    if (false)
      $.throwExpression($.InvalidOperationError$("That's just sad. Give me a good argName"));
    if (false)
      $.throwExpression($.InvalidOperationError$("That's just sad. Give me a good argName"));
    if (!this.get$canForward())
      $.throwExpression($._ExceptionImplementation$("Forward cannot be called"));
    t1 = this._child;
    if (t1 != null) {
      if (false)
        $.throwExpression($.InvalidOperationError$("That's just sad. Give me a good argName"));
      ...
      tempCtx = $.get$context2D$x(tempCanvas);
      t2 = t1.background;
      if (t2 != null) {
        tempCtx.fillStyle = t2;
        tempCtx.fillRect(0, 0, t1.get$width(t1), t1.get$height(t1));
      }
      $.ParentThing.prototype.drawOverride$1.call(t1, tempCtx);
    ...
    if (this._lastDrawTime != null) {
      ...
      t1.get$stream(t1)._liblib1$_add$1($.C_EventArgs);
...
$$._NavLayerTxPanel = {"": "PanelThing;_frames,_lastImage,_newChild,_startTx,_goalTx,_myTx,_i,_children,background,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  update$0: function() {
    ...
    if (t1 < t2) {
      ...
      if (false)
        $.throwExpression($.InvalidOperationError$("That's just sad. Give me a good argName"));
      t1.setTransform$6(t1, newTx._scX, newTx._shY, newTx._shX, newTx._scY, newTx._tX, newTx._tY);
      t1 = this._lastImage;
...
$$.TextThing = {"": "Thing;_liblib2$_value,fillStyle',textFillStyle,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  drawOverride$1: function(ctx) {
    var t1, t2;
    t1 = this.fillStyle;
    if (t1 != null) {
    ...
    t1.fillText$3(ctx, this._liblib2$_value, 0, 0);
  }
};
...
$$.CanvasRenderingContext2D = {"": "CanvasRenderingContext;fillStyle},globalAlpha%,textBaseline}",
  ...
  drawImageToRect$3$sourceRect: function(receiver, source, destRect, sourceRect) {
    ...
    if (sourceRect == null)
      ...
      receiver.drawImage(source, $.JSNull_methods.get$left(sourceRect), $.JSNull_methods.get$top(sourceRect), $.JSNull_methods.get$width(sourceRect), $.JSNull_methods.get$height(sourceRect), t1, t2, t3, t4);
  },
...
$.main = function() {
  var demo = $.NavDemo$_internal(document.querySelector("#content"), $.NavThing$(300, 300));
...
$.NavDemo__getDemoElement = function(count) {
  var canvas, $back, t1, text, t2, corner;
  ...
  t2 = $.Coordinate$(100, 100);
  $.get$PanelThing__containerTransformProperty().get$1(text).setToTranslation$2(t2.x, t2.y);
  if (text._disposed)
    $.throwExpression($.DisposedError_SMD);
  if (text._lastDrawTime != null) {
    text._lastDrawTime = null;
    t2 = text._invalidatedEventHandle;
    t2.get$stream(t2)._liblib1$_add$1($.C_EventArgs);
    text._parent.childInvalidated$1(text);
  }
  corner = $.ShapeThing$(100, 100, "red", $.ShapeType_Rect);
  canvas.insertAt$2(corner, t1.length);
  t2 = $.Coordinate$(0, 0);
  $.get$PanelThing__containerTransformProperty().get$1(corner).setToTranslation$2(t2.x, t2.y);
  if (corner._disposed)
    $.throwExpression($.DisposedError_SMD);
  if (corner._lastDrawTime != null) {
    corner._lastDrawTime = null;
    t2 = corner._invalidatedEventHandle;
    t2.get$stream(t2)._liblib1$_add$1($.C_EventArgs);
    corner._parent.childInvalidated$1(corner);
  }
  ...
  canvas.insertAt$2(corner, t1.length);
  t1 = $.Coordinate$(200, 200);
  $.get$PanelThing__containerTransformProperty().get$1(corner).setToTranslation$2(t1.x, t1.y);
  if (corner._disposed)
    $.throwExpression($.DisposedError_SMD);
  if (corner._lastDrawTime != null) {
    corner._lastDrawTime = null;
    t1 = corner._invalidatedEventHandle;
    t1.get$stream(t1)._liblib1$_add$1($.C_EventArgs);
    corner._parent.childInvalidated$1(corner);
  }
  return canvas;
...
$.isValidNumber = function(value) {
  return !$.JSNumber_methods.get$isInfinite(value) && !$.JSNumber_methods.get$isNaN(value);
};

$.lerp = function(a, b, x) {
  var t1, t2, message, t3;
  t1 = $.getInterceptor(a);
  t2 = a != null && !t1.get$isInfinite(a) && !t1.get$isNaN(a);
  if (false)
    $.throwExpression($.InvalidOperationError$("That's just sad. Give me a good argName"));
  if (!t2) {
    message = true ? "value was invalid" : null;
    $.throwExpression($.DetailedArgumentError$("a", message));
  }
  t2 = $.getInterceptor(b);
  t3 = b != null && !t2.get$isInfinite(b) && !t2.get$isNaN(b);
  if (false)
    $.throwExpression($.InvalidOperationError$("That's just sad. Give me a good argName"));
  if (!t3) {
    message = true ? "value was invalid" : null;
  ...
  t3 = !$.JSNumber_methods.get$isInfinite(x) && !$.JSNumber_methods.get$isNaN(x);
  if (false)
    $.throwExpression($.InvalidOperationError$("That's just sad. Give me a good argName"));
  if (!t3) {
    message = true ? "value was invalid" : null;
    $.throwExpression($.DetailedArgumentError$("x", message));
  }
  t2 = t2.$sub(b, a);
  if (typeof t2 !== "number")
    throw $.iae(t2);
...
$.requireArgument = function(truth, argName, message) {
  ...
  if (truth !== true) {
    ...
    $.throwExpression($.DetailedArgumentError$(argName, message));
  }
};
...
$.NavThing$ = function(width, height) {
  return new $.NavThing($.VerticalAlignment_middle, $.HorizontalAlignment_center, null, null, null, $.List_List($), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
};
...
$._NavLayerTxPanel__NavLayerTxPanel = function(width, height, lastCanvas, newChild, startTx, ghostTx, frameCount, horizontalAlignment, verticalAlignment, childOffset) {
  var t1, lastImage, tx, newChildOffset, goalTx;
  if (childOffset == null)
  ...
  if (lastImage._disposed)
    $.throwExpression($.DisposedError_SMD);
  tx = $.AffineTransform$(1, 0, 0, 1, 0, 0);
  lastImage._transforms.push(tx);
  t1 = startTx.createInverse$0();
  if (false)
    $.throwExpression($.InvalidOperationError$("That's just sad. Give me a good argName"));
  tx.setTransform$6(tx, t1._scX, t1._shY, t1._shX, t1._scY, t1._tX, t1._tY);
...
$._NavLayerTxPanel$_internal = function(width, height, _frames, _lastImage, _newChild, _startTx, _goalTx) {
  var t1 = new $._NavLayerTxPanel(_frames, _lastImage, _newChild, _startTx, _goalTx, null, 0, $.List_List($), null, $.List_List($), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
...
$.RetainedUtil_getOffsetVector = function(parentSize, childSize, horizontalAlignment, verticalAlignment, offset) {
  ...
  if (false)
    $.throwExpression($.InvalidOperationError$("That's just sad. Give me a good argName"));
  if (offset == null)
    $.throwExpression($.NullArgumentError$("offset"));
  x = offset.x;
  y = offset.y;
  switch (horizontalAlignment) {
    ...
    case $.HorizontalAlignment_center:
      x = $.$add$ns(x, $.$div$n($.$sub$n(parentSize.width, childSize.width), 2));
      break;
    case $.HorizontalAlignment_right:
      x = $.$add$ns(x, $.$sub$n(parentSize.width, childSize.width));
      break;
    default:
      $.throwExpression($.ArgumentError$("horizontalAlignment value not expected " + $.S(horizontalAlignment)));
  }
  switch (verticalAlignment) {
    case $.VerticalAlignment_top:
      break;
    case $.VerticalAlignment_middle:
      y = $.$add$ns(y, $.$div$n($.$sub$n(parentSize.height, childSize.height), 2));
      break;
    case $.VerticalAlignment_bottom:
      y = $.$add$ns(y, $.$sub$n(parentSize.height, childSize.height));
      break;
    default:
      $.throwExpression($.ArgumentError$("verticalAlignment value not expected " + $.S(verticalAlignment)));
  }
  return $.Vector$(x, y);
};
...
$.SubCanvasThing$ = function(width, height, _canvas) {
  return new $.SubCanvasThing(_canvas, $.List_List($), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
};

$.TextThing$ = function(_value, width, height) {
  return new $.TextThing(_value, "white", "black", $.List_List($), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
};
