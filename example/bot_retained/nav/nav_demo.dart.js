...
lerp: function(a, b, x) {
  var t1;
  $.requireArgument($.isValidNumber(a), "a", null);
  $.requireArgument($.isValidNumber(b), "b", null);
  $.requireArgument($.isValidNumber(x), "x", null);
  t1 = $.$sub$n(b, a);
  if (typeof t1 !== "number")
    throw $.iae(t1);
  return $.$add$ns(a, x * t1);
},
...
AffineTransform: {"": "Object;_scX<,_shY<,_shX<,_scY<,_tX<,_tY<",
  ...
  transformCoordinate$1: function(point) {
    ...
    return new $.Coordinate($.$add$ns($.$add$ns(t2.$mul(t1, this._scX), t4.$mul(t3, this._shX)), this._tX), $.$add$ns($.$add$ns(t2.$mul(t1, this._shY), t4.$mul(t3, this._scY)), this._tY));
  },
  ...
  lerpTx$2: function(other, x) {
    $._metaRequireArgumentNotNullOrEmpty("other");
    return $.AffineTransform$($.lerp(this._scX, other._scX, x), $.lerp(this._shY, other._shY, x), $.lerp(this._shX, other._shX, x), $.lerp(this._scY, other._scY, x), $.lerp(this._tX, other._tX, x), $.lerp(this._tY, other._tY, x));
  },
  clone$0: function(_) {
...
RetainedUtil_getOffsetVector: function(parentSize, childSize, horizontalAlignment, verticalAlignment, offset) {
  var t1, x, y;
  $._metaRequireArgumentNotNullOrEmpty("parentSize");
  $._metaRequireArgumentNotNullOrEmpty("childSize");
  $._metaRequireArgumentNotNullOrEmpty("horizontalAlignment");
  $._metaRequireArgumentNotNullOrEmpty("verticalAlignment");
  $._metaRequireArgumentNotNullOrEmpty("offset");
  if (offset == null) {
    t1 = new $.NullArgumentError("offset", "cannot be null", null);
  ...
  switch (horizontalAlignment) {
    ...
    case $.HorizontalAlignment_center:
      t1 = $.$sub$n(parentSize.width, childSize.width);
      if (typeof t1 !== "number")
        throw t1.$div();
      x = $.$add$ns(x, t1 / 2);
      break;
    case $.HorizontalAlignment_right:
      x = $.$add$ns(x, $.$sub$n(parentSize.width, childSize.width));
      break;
    default:
      throw $.wrapException(new $.ArgumentError("horizontalAlignment value not expected " + $.S(horizontalAlignment)));
  }
  switch (verticalAlignment) {
    case $.VerticalAlignment_top:
      break;
    case $.VerticalAlignment_middle:
      t1 = $.$sub$n(parentSize.height, childSize.height);
      if (typeof t1 !== "number")
        throw t1.$div();
      y = $.$add$ns(y, t1 / 2);
      break;
    case $.VerticalAlignment_bottom:
      y = $.$add$ns(y, $.$sub$n(parentSize.height, childSize.height));
      break;
    default:
      throw $.wrapException(new $.ArgumentError("verticalAlignment value not expected " + $.S(verticalAlignment)));
  }
...
CanvasThing: {"": "PanelThing;_liblib4$_children,background,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
...
NavThing: {"": "ParentThing;verticalAlignment,horizontalAlignment,_child,_txPanel,_childOffset,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  forward$3: function(thing, tx, frameCount) {
    ...
    $._metaRequireArgumentNotNullOrEmpty("tx");
    $._metaRequireArgumentNotNullOrEmpty("frameCount");
    if (this._txPanel != null)
      $.throwExpression(new $._ExceptionImplementation("Forward cannot be called"));
    t1 = this._child;
    if (t1 != null) {
      ...
      this._child = null;
      t1.get$width;
      t2 = $.toInt$0$nx(t1._width);
      t1.get$height;
      tempCanvas = $.CanvasElement_CanvasElement($.toInt$0$nx(t1._height), t2);
      t1.drawOverride$1($.get$context2D$x(tempCanvas));
      this._txPanel = $._NavLayerTxPanel__NavLayerTxPanel(this._width, this._height, tempCanvas, thing, tx, existingTx, frameCount, this.horizontalAlignment, this.verticalAlignment, this._childOffset);
...
_NavLayerTxPanel: {"": "PanelThing;_frames,_lastImage,_newChild,_startTx,_goalTx,_myTx,_i,_liblib4$_children,background,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  update$0: function() {
...
_NavLayerTxPanel__NavLayerTxPanel: function(width, height, lastCanvas, newChild, startTx, ghostTx, frameCount, horizontalAlignment, verticalAlignment, childOffset) {
  var t1, t2, lastImage, newChildOffset, goalTx;
  childOffset = new $.Vector(0, 0);
  t1 = $.getInterceptor$x(lastCanvas);
  t2 = t1.get$width(lastCanvas);
  t1 = t1.get$height(lastCanvas);
  lastImage = new $.SubCanvasThing(lastCanvas, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, t2, t1, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  lastImage.addTransform$0().setFromTransfrom$1(startTx.createInverse$0());
  newChildOffset = $.RetainedUtil_getOffsetVector(new $.Size(width, height), new $.Size(newChild._width, newChild._height), horizontalAlignment, verticalAlignment, childOffset);
  goalTx = $.AffineTransform$(1, 0, 0, 1, newChildOffset.x, newChildOffset.y);
  return $._NavLayerTxPanel$_internal(width, height, frameCount, lastImage, newChild, $.clone$0$x(ghostTx).concatenate$1(startTx), goalTx);
},

_NavLayerTxPanel$_internal: function(width, height, _frames, _lastImage, _newChild, _startTx, _goalTx) {
  var t1 = new $._NavLayerTxPanel(_frames, _lastImage, _newChild, _startTx, _goalTx, null, 0, $.List_List(null), null, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, width, height, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
...
PanelThing: {"": "ParentThing;",
  add$1: function(_, thing) {
    this.insertAt$2(thing, this._liblib4$_children.length);
  },
  ...
  remove$1: function(_, thing) {
    ...
    t1 = this._liblib4$_children;
    index = $.Arrays_indexOf(t1, thing, 0, t1.length);
    if (index < 0)
      return false;
    else {
      ...
      item._remove$1($.get$PanelThing__containerTransformProperty());
      return true;
    }
  },
  getVisualChild$1: function(index) {
  ...
  get$visualChildCount: function() {
    return this._liblib4$_children.length;
  },
...
SubCanvasThing: {"": "Thing;_canvas,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  drawOverride$1: function(ctx) {
    $.drawImageToRect$2$x(ctx, this._canvas, new $.Rect(0, 0, this._width, this._height));
  }
},

TextThing: {"": "Thing;_liblib4$_value,fillStyle',textFillStyle,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  drawOverride$1: function(ctx) {
    var t1, t2;
    t1 = this.fillStyle;
    if (t1 != null) {
    ...
    t1 = $.getInterceptor$x(ctx);
    t1.set$fillStyle(ctx, this.textFillStyle);
    t1.set$textBaseline(ctx, "top");
    t1.fillText$3(ctx, this._liblib4$_value, 0, 0);
  }
},
...
Thing: {"": "AttachableObject;",
  ...
  set$alpha: function(_, value) {
    ...
    $.requireArgument(value >= 0 && value <= 1, "value", null);
    this._alpha = value;
  ...
  removeTransform$1: function(tx) {
    ...
    $._metaRequireArgumentNotNullOrEmpty("tx");
    if (tx == null) {
      t1 = new $.NullArgumentError("tx", "cannot be null", null);
      t1.DetailedArgumentError$2("tx", "cannot be null");
      $.throwExpression(t1);
    }
    t1 = this._transforms;
    index = $.Arrays_indexOf(t1, tx, 0, t1.length);
    if (index < 0)
      return false;
    else {
  ...
  unregisterParent$1: function($parent) {
    $._metaRequireArgumentNotNullOrEmpty("parent");
    $.requireArgument($parent === this._parent, "parent", null);
    this._parent = null;
  },
...
_BroadcastSubscription: {"": "_ControllerSubscription;_eventState@,_next@,_previous@,_liblib3$_controller,_liblib3$_onData,_onError,_onDone,_zone,_state,_pending",
...
CanvasRenderingContext2D: {"": "CanvasRenderingContext;fillStyle},globalAlpha%,textBaseline}",
...
["nav_demo.dart", "nav_demo.dart", , {
main: function() {
  $.NavDemo_NavDemo(document.querySelector("#content")).requestFrame$0();
},
...
NavDemo: {"": "StageWrapper;_count,canvas,stage,rootThing,_invalidatedEventSub,_frameRequested,_disposed",
  ...
  _canvas_mouseDown$1: function(e) {
    var t1, hits;
    t1 = $.get$offset$x(e);
    hits = $.RetainedUtil__hitTest(this.stage.rootThing, new $.Coordinate(t1.get$x(t1), t1.get$y(t1)));
    t1 = $.getInterceptor$asx(hits);
    if ($.$gt$n(t1.get$length(hits), 0))
      this._itemClick$1(t1.get$first(hits));
  },
  get$_canvas_mouseDown: function() {
    return new $.BoundClosure$1(this, "_canvas_mouseDown$1", null);
  },
  _itemClick$1: function(element) {
    var t1, tx, lastTx;
    if ($.$eq($.get$width$x(element), 300)) {
      t1 = $.AffineTransform$(1, 0, 0, 1, 100, 100);
      tx = t1.scale$2(t1, 0.3333333333333333, 0.3333333333333333).createInverse$0();
    } else {
      lastTx = element.getTransform$0();
      t1 = $.AffineTransform$(1, 0, 0, 1, lastTx._tX, lastTx._tY);
  ...
  NavDemo$_internal$2: function(canvas, nav) {
    ...
    t1 = new $._EventStream(canvas, $.EventStreamProvider_mousedown._eventType, false);
    new $._EventStreamSubscription(0, t1._liblib0$_target, t1._eventType, this.get$_canvas_mouseDown(), t1._useCapture)._tryResume$0();
  },
  static: {
NavDemo_NavDemo: function(canvas) {
  return $.NavDemo$_internal(canvas, new $.NavThing($.VerticalAlignment_middle, $.HorizontalAlignment_center, null, null, null, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, 300, 300, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false));
},

NavDemo$_internal: function(canvas, nav) {
  var t1 = new $.Stage(new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), canvas, nav, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  t1.rootThing.registerParent$1(t1);
  t1 = new $.NavDemo(0, canvas, t1, nav, null, false, false);
...
NavDemo__getDemoElement: function(count) {
  var canvas, $back, t1, text, corner;
  canvas = new $.CanvasThing($.List_List(null), null, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, 300, 300, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  $back = new $.ShapeThing("#333", $.ShapeType_Rect, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, 300, 300, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  $back.set$alpha($back, 0.5);
  t1 = canvas._liblib4$_children;
  canvas.insertAt$2($back, t1.length);
  text = new $.TextThing("Click here - " + count, "white", "black", $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, 100, 100, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  canvas.insertAt$2(text, t1.length);
  canvas.setTopLeft$2(text, new $.Coordinate(100, 100));
  corner = new $.ShapeThing("red", $.ShapeType_Rect, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, 100, 100, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  canvas.insertAt$2(corner, t1.length);
  canvas.setTopLeft$2(corner, new $.Coordinate(0, 0));
  corner = new $.ShapeThing("green", $.ShapeType_Rect, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, 100, 100, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  canvas.insertAt$2(corner, t1.length);
  canvas.setTopLeft$2(corner, new $.Coordinate(200, 0));
  corner = new $.ShapeThing("blue", $.ShapeType_Rect, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, 100, 100, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  canvas.insertAt$2(corner, t1.length);
  canvas.setTopLeft$2(corner, new $.Coordinate(0, 200));
  corner = new $.ShapeThing("yellow", $.ShapeType_Rect, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, 100, 100, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  canvas.insertAt$2(corner, t1.length);
  canvas.setTopLeft$2(corner, new $.Coordinate(200, 200));
  return canvas;
}}
...
Isolate.$lazy($, "_navLayerTransformProp", "NavThing__navLayerTransformProp", "get$NavThing__navLayerTransformProp", function() {
  return new $.Property(null, "navLayerTxProp");
});
