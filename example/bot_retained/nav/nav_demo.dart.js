...
AffineTransform: {"": "Object;_scX<,_shY<,_shX<,_scY<,_tX<,_tY<",
  ...
  transformCoordinate$1: function(point) {
    ...
    return $.Coordinate$($.$add$ns($.$add$ns(t2.$mul(t1, this._scX), t4.$mul(t3, this._shX)), this._tX), $.$add$ns($.$add$ns(t2.$mul(t1, this._shY), t4.$mul(t3, this._scY)), this._tY));
  },
...
getMouseEventCoordinate: function($event) {
  return $._p2c($.get$offset$x($event));
}}],
...
NavThing: {"": "ParentThing;verticalAlignment,horizontalAlignment,_child,_txPanel,_childOffset,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  forward$3: function(thing, tx, frameCount) {
    ...
    if (t1 != null) {
      ...
      this._child = null;
      t2 = $.toInt$0$nx(t1.get$width(t1));
      tempCanvas = $.CanvasElement_CanvasElement($.toInt$0$nx(t1.get$height(t1)), t2);
      t1.drawOverride$1($.get$context2D$x(tempCanvas));
      this._txPanel = $._NavLayerTxPanel__NavLayerTxPanel(this.get$width(this), this.get$height(this), tempCanvas, thing, tx, existingTx, frameCount, this.horizontalAlignment, this.verticalAlignment, this._childOffset);
...
_NavLayerTxPanel: {"": "PanelThing;_frames,_lastImage,_newChild,_startTx,_goalTx,_myTx,_i,_liblib4$_children,background,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  _NavLayerTxPanel$_internal$7: function(width, height, _frames, _lastImage, _newChild, _startTx, _goalTx) {
    this.add$1(this, this._lastImage);
    this.add$1(this, this._newChild);
...
SubCanvasThing: {"": "Thing;_canvas,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  drawOverride$1: function(ctx) {
    $.drawImageToRect$2$x(ctx, this._canvas, $.Rect$(0, 0, this.get$width(this), this.get$height(this)));
  }
},
...
NavThing$: function(width, height) {
  return new $.NavThing($.VerticalAlignment_middle, $.HorizontalAlignment_center, null, null, null, $.List_List(null), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
},
...
_NavLayerTxPanel__NavLayerTxPanel: function(width, height, lastCanvas, newChild, startTx, ghostTx, frameCount, horizontalAlignment, verticalAlignment, childOffset) {
  var t1, lastImage, newChildOffset, goalTx;
  childOffset = $.Vector$(0, 0);
  t1 = $.getInterceptor$x(lastCanvas);
  lastImage = $.SubCanvasThing$(t1.get$width(lastCanvas), t1.get$height(lastCanvas), lastCanvas);
  lastImage.addTransform$0().setFromTransfrom$1(startTx.createInverse$0());
  newChildOffset = $.RetainedUtil_getOffsetVector($.Size$(width, height), newChild.get$size(newChild), horizontalAlignment, verticalAlignment, childOffset);
  goalTx = $.AffineTransform_AffineTransform$fromTranslat(newChildOffset.x, newChildOffset.y);
...
_NavLayerTxPanel$_internal: function(width, height, _frames, _lastImage, _newChild, _startTx, _goalTx) {
  var t1 = new $._NavLayerTxPanel(_frames, _lastImage, _newChild, _startTx, _goalTx, null, 0, $.List_List(null), null, $.List_List(null), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
...
RetainedUtil_getOffsetVector: function(parentSize, childSize, horizontalAlignment, verticalAlignment, offset) {
  ...
  switch (horizontalAlignment) {
    ...
    case $.HorizontalAlignment_right:
      ...
      break;
    default:
      throw $.wrapException($.ArgumentError$("horizontalAlignment value not expected " + $.S(horizontalAlignment)));
  }
  switch (verticalAlignment) {
    ...
    case $.VerticalAlignment_bottom:
      ...
      break;
    default:
      throw $.wrapException($.ArgumentError$("verticalAlignment value not expected " + $.S(verticalAlignment)));
  }
  return $.Vector$(x, y);
},

RetainedUtil_hitTest: function(stage, point) {
  return $.RetainedUtil__hitTest(stage.rootThing, point);
},
...
SubCanvasThing$: function(width, height, _canvas) {
  return new $.SubCanvasThing(_canvas, $.List_List(null), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
},

TextThing$: function(_value, width, height) {
  return new $.TextThing(_value, "white", "black", $.List_List(null), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
}}],
...
_BroadcastStream: {"": "_StreamImpl;_liblib1$_controller",
  _createSubscription$4: function(onData, onError, onDone, cancelOnError) {
    return this._liblib1$_controller._subscribe$4(onData, onError, onDone, cancelOnError);
  }
},

_BroadcastSubscription: {"": "_ControllerSubscription;_eventState@,_next@,_previous@,_liblib1$_controller,_liblib1$_onData,_onError,_onDone,_zone,_state,_pending",
...
_ZoneTimer: {"": "Object;_zone<,_liblib1$_callback,_timer",
  _run$0: function() {
    this._zone.executeCallbackGuarded$1(this._liblib1$_callback);
  },
  get$_run: function() {
...
_EventStream: {"": "Stream;_liblib3$_target,_eventType,_useCapture",
  listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
    return $._EventStreamSubscription$(this._liblib3$_target, this._eventType, onData, this._useCapture);
  },
  listen$1: function(onData) {
    return this.listen$4$cancelOnError$onDone$onError(onData, null, null, null);
  }
...
_EventStreamSubscription: {"": "StreamSubscription;_pauseCount,_liblib3$_target,_eventType,_onData,_useCapture",
  ...
  get$_canceled: function() {
    return this._liblib3$_target == null;
  },
...
NavDemo: {"": "StageWrapper;_count,canvas,stage,rootThing,_invalidatedEventSub,_frameRequested,_disposed",
  ...
  _canvas_mouseDown$1: function(e) {
    var hits, t1;
    hits = $.RetainedUtil_hitTest(this.stage, $.getMouseEventCoordinate(e));
  ...
  _itemClick$1: function(element) {
    ...
    if ($.$eq($.get$width$x(element), 300)) {
      t1 = $.AffineTransform_AffineTransform$fromTranslat(100, 100);
      tx = t1.scale$2(t1, 0.3333333333333333, 0.3333333333333333).createInverse$0();
    } else {
      lastTx = element.getTransform$0();
      t1 = $.AffineTransform_AffineTransform$fromTranslat(lastTx.get$translateX(), lastTx.get$translateY());
  ...
  NavDemo$_internal$2: function(canvas, nav) {
    ...
    $.get$onMouseDown$x(canvas).listen$1(this.get$_canvas_mouseDown());
  }
},
...
NavDemo__getDemoElement: function(count) {
  ...
  $back = $.ShapeThing$(300, 300, "#333", $.ShapeType_Rect);
  $back.set$alpha($back, 0.5);
  canvas.add$1(canvas, $back);
  text = $.TextThing$("Click here - " + count, 100, 100);
  canvas.add$1(canvas, text);
  canvas.setTopLeft$2(text, $.Coordinate$(100, 100));
  corner = $.ShapeThing$(100, 100, "red", $.ShapeType_Rect);
  canvas.add$1(canvas, corner);
  canvas.setTopLeft$2(corner, $.Coordinate$(0, 0));
  corner = $.ShapeThing$(100, 100, "green", $.ShapeType_Rect);
  canvas.add$1(canvas, corner);
  canvas.setTopLeft$2(corner, $.Coordinate$(200, 0));
  corner = $.ShapeThing$(100, 100, "blue", $.ShapeType_Rect);
  canvas.add$1(canvas, corner);
  canvas.setTopLeft$2(corner, $.Coordinate$(0, 200));
  corner = $.ShapeThing$(100, 100, "yellow", $.ShapeType_Rect);
  canvas.add$1(canvas, corner);
