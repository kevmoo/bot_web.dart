...
_NavLayerTxPanel__NavLayerTxPanel: function(width, height, lastCanvas, newChild, startTx, ghostTx, frameCount, horizontalAlignment, verticalAlignment, childOffset) {
  ...
  new $.SubCanvasThing(lastCanvas, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, t2, t1, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false).addTransform$0().setFromTransfrom$1(startTx.createInverse$0());
  $.RetainedUtil_getOffsetVector(new $.Size(width, height), new $.Size(newChild._width, newChild._height), horizontalAlignment, verticalAlignment, childOffset);
},
...
TextThing: {"": "Thing;_value,fillStyle',textFillStyle,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  drawOverride$1: function(ctx) {
    var t1, t2;
    t1 = this.fillStyle;
    if (t1 != null) {
    ...
    t1.fillText$3(ctx, this._value, 0, 0);
  }
},
...
LinkedHashMapCell: {"": "Object;_key<,_liblib2$_value@,_liblib2$_next?,_liblib2$_previous"},
  ...
  moveNext$0: function() {
    ...
    if (this._modifications !== t1._modifications)
      ...
      if (t1 == null) {
        ...
        this._cell = this._cell._liblib2$_next;
        return true;
      }
    }
  }
