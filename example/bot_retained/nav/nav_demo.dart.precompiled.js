...
Interceptor: {"": "Object;",
  ...
  "%": "CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|SVGAnimatedTransformList"
},
...
isValidNumber: function(value) {
  ...
  if (value != null) {
    value.toString;
    t1 = !(value == Infinity || value == -Infinity) && !isNaN(value);
  } else
    t1 = false;
  return t1;
},
...
AffineTransform: {"": "Object;_scX<,_shY,_shX,_scY,_tX,_tY",
  ...
  transformCoordinate$1: function(point) {
    ...
    if (typeof t9 !== "number")
      throw H.iae(t9);
    t9 = new X.Coordinate(t1 * t2 + t3 * t4 + t5, t6 * t7 + t3 * t8 + t9);
  ...
  $eq: function(_, other) {
    ...
    if (this._scX === other.get$_scX())
      if (this._shX === other._shX) {
        t1 = this._tX;
        t2 = other._tX;
        if (t1 == null ? t2 == null : t1 === t2)
          if (this._shY === other._shY)
            if (this._scY === other._scY) {
              t1 = this._tY;
              t2 = other._tY;
...
Coordinate: {"": "Point;x,y", $asPoint: null},
...
RetainedUtil_getOffsetVector: function(parentSize, childSize, horizontalAlignment, verticalAlignment, offset) {
  ...
  if (offset == null)
    H.throwExpression(X.NullArgumentError$("offset"));
  x = offset.x;
  y = offset.y;
...
RetainedUtil__hitTest: function(thing, point) {
  var tx, bounds, hits, t1, $length, i, t2;
...
NavThing: {"": "ParentThing;verticalAlignment,horizontalAlignment,_child,_txPanel,_childOffset,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  forward$3: function(thing, tx, frameCount) {
    ...
    if (this._txPanel != null)
      H.throwExpression(P.Exception_Exception("Forward cannot be called"));
    t1 = this._child;
    if (t1 != null) {
...
PanelThing: {"": "ParentThing;",
  ...
  insertAt$2: function(thing, index) {
    ...
    X._metaRequireArgumentNotNullOrEmpty("thing");
    if (thing == null)
      H.throwExpression(X.NullArgumentError$("thing"));
...
TextThing: {"": "Thing;_bot_retained$_value,fillStyle,textFillStyle,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  drawOverride$1: function(ctx) {
    ...
    J.fillText$3$x(ctx, this._bot_retained$_value, 0, 0);
  }
},
...
Thing: {"": "AttachableObject;",
  ...
  removeTransform$1: function(tx) {
    ...
    X._metaRequireArgumentNotNullOrEmpty("tx");
    if (tx == null)
      H.throwExpression(X.NullArgumentError$("tx"));
    t1 = this._transforms;
...
_BroadcastSubscription: {"": "_ControllerSubscription;_eventState,_async$_next@,_previous?,_async$_controller,_async$_onData,_onError,_onDone,_zone,_state,_cancelFuture,_pending",
...
NavDemo: {"": "StageWrapper;_count,canvas,stage,rootThing,_invalidatedEventSub,_frameRequested,_disposed",
  ...
  _canvas_mouseDown$1: function(e) {
    var hits, t1, t2;
    hits = B.RetainedUtil__hitTest(this.stage.rootThing, J.get$offset$x(e));
    t1 = J.getInterceptor$asx(hits);
    t2 = t1.get$length(hits);
    if (typeof t2 !== "number")
      throw t2.$gt();
    if (t2 > 0)
  ...
  get$_canvas_mouseDown: function() {
    return new H.BoundClosure$1(this, K.NavDemo.prototype._canvas_mouseDown$1, null, "_canvas_mouseDown$1");
  },
  _itemClick$1: function(element) {
    var t1, tx, lastTx;
    if (J.get$width$x(element) === 300) {
...
function dart_precompiled($collectedClasses) {
  ...
  function _BroadcastSubscription(_eventState, _async$_next, _previous, _async$_controller, _async$_onData, _onError, _onDone, _zone, _state, _cancelFuture, _pending) {
