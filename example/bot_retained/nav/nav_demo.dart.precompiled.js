...
Util_getHashCode: function(source) {
  ...
  for (t1 = new H.ListIterator(source, 2, 0, null), hash = 0; t1.moveNext$0();) {
    h = t1._current;
...
AffineTransform: {"": "Object;_scX<,_shY<,_shX<,_scY<,_tX<,_tY<",
  ...
  transformCoordinate$1: function(point) {
    ...
    if (typeof t8 !== "number")
      throw H.iae(t8);
    t8 = new X.Coordinate(t1 * t2 + t3 * t4 + t5, t1 * t6 + t3 * t7 + t8);
...
NavThing: {"": "ParentThing;verticalAlignment,horizontalAlignment,_child,_txPanel,_childOffset,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  forward$3: function(thing, tx, frameCount) {
    ...
    if (t1 != null) {
      ...
      this._child = null;
      t2 = J.toInt$0$n(t1._width);
      tempCanvas = W.CanvasElement_CanvasElement(J.toInt$0$n(t1._height), t2);
...
_NavLayerTxPanel: {"": "PanelThing;_frames,_lastImage,_newChild,_startTx,_goalTx,_myTx,_i,_children,background,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  ...
  _bot_retained$_NavLayerTxPanel$_internal$7: function(width, height, _frames, _lastImage, _newChild, _startTx, _goalTx) {
...
_NavLayerTxPanel__NavLayerTxPanel: function(width, height, lastCanvas, newChild, startTx, ghostTx, frameCount, horizontalAlignment, verticalAlignment, childOffset) {
  ...
  H.setRuntimeTypeInfo(childOffset, [null]);
  t1 = lastCanvas.width;
...
_NavLayerTxPanel$_internal: function(width, height, _frames, _lastImage, _newChild, _startTx, _goalTx) {
  ...
  t2._bot_retained$_NavLayerTxPanel$_internal$7(width, height, _frames, _lastImage, _newChild, _startTx, _goalTx);
  return t2;
}}
...
SubCanvasThing: {"": "Thing;_canvas,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  drawOverride$1: function(ctx) {
    ...
    J.drawImageToRect$2$x(ctx, this._canvas, rect);
  }
},

TextThing: {"": "Thing;_bot_retained$_value,fillStyle,textFillStyle,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  drawOverride$1: function(ctx) {
    ctx.fillStyle = this.fillStyle;
    ctx.fillRect(0, 0, this._width, this._height);
    ctx.fillStyle = this.textFillStyle;
    ctx.textBaseline = "top";
    ctx.fillText(this._bot_retained$_value, 0, 0);
  }
},
...
_BroadcastSubscription: {"": "_ControllerSubscription;_eventState@,_async$_next@,_previous?,_async$_controller,_async$_onData,_onError,_onDone,_zone,_state,_pending",
...
_SyncBroadcastStreamController: {"": "_BroadcastStreamController;_onListen,_onCancel,_state,_async$_next,_previous,_addStreamState,_doneFuture",
...
_AsyncBroadcastStreamController: {"": "_BroadcastStreamController;_onListen,_onCancel,_state,_async$_next,_previous,_addStreamState,_doneFuture",
  _sendData$1: function(data) {
    var link;
...
_RectangleBase: {"": "Object;",
  ...
  $eq: function(_, other) {
    ...
    if (t2 == null ? t3 == null : t2 === t3) {
      ...
      t3 = t1.get$top(other);
      t1 = (t2 == null ? t3 == null : t2 === t3) && J.$eq(this.get$width(this), t1.get$width(other)) && J.$eq(this.get$height(this), t1.get$height(other));
    } else
      t1 = false;
    return t1;
  },
...
NavDemo: {"": "StageWrapper;_count,canvas,stage,rootThing,_invalidatedEventSub,_frameRequested,_disposed",
  ...
  _canvas_mouseDown$1: function(e) {
    var t1, point, hits;
    t1 = J.get$offset$x(e);
    point = new X.Coordinate(t1.get$x(t1), t1.get$y(t1));
    H.setRuntimeTypeInfo(point, [null]);
    hits = B.RetainedUtil__hitTest(this.stage.rootThing, point);
    if (hits.length > 0)
...
NavDemo__getDemoElement: function(count) {
  ...
  t3 = new X.Coordinate(100, 100);
  H.setRuntimeTypeInfo(t3, [null]);
  canvas.setTopLeft$2(text, t3);
  t3 = P.List_List(null, X.AffineTransform);
  H.setRuntimeTypeInfo(t3, [X.AffineTransform]);
  ...
  t3 = new X.Coordinate(0, 0);
  H.setRuntimeTypeInfo(t3, [null]);
  canvas.setTopLeft$2(corner, t3);
  t3 = P.List_List(null, X.AffineTransform);
  H.setRuntimeTypeInfo(t3, [X.AffineTransform]);
  ...
  canvas.insertAt$2(corner, t2.length);
  t2 = new X.Coordinate(200, 200);
  H.setRuntimeTypeInfo(t2, [null]);
  canvas.setTopLeft$2(corner, t2);
  return canvas;
}}
...
function dart_precompiled($collectedClasses) {
  ...
  function TextThing(_bot_retained$_value, fillStyle, textFillStyle, _transforms, _invalidatedEventHandle, _cacheCanvas, _width, _height, _alpha, _cacheEnabled, _lastDrawTime, _parent, _propertyValues, _eventHandlers, _disposed) {
    this._bot_retained$_value = _bot_retained$_value;
  ...
  function _BroadcastSubscription(_eventState, _async$_next, _previous, _async$_controller, _async$_onData, _onError, _onDone, _zone, _state, _pending) {
  ...
  function _SyncBroadcastStreamController(_onListen, _onCancel, _state, _async$_next, _previous, _addStreamState, _doneFuture) {
  ...
  function _AsyncBroadcastStreamController(_onListen, _onCancel, _state, _async$_next, _previous, _addStreamState, _doneFuture) {
    this._onListen = _onListen;
    this._onCancel = _onCancel;
    this._state = _state;
    this._async$_next = _async$_next;
