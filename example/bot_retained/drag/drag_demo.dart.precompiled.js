...
// Native classes
// Bound closures
$$.BoundClosure$1 = [X, {"": "BoundClosure;_self,_target,_receiver,_liblib5$_name",
  call$1: function(p0) {
...
$$.Closure$_demoIsolate = [R, {"": "Closure;call$0,$name", $is_void_: true}];
...
AffineTransform: {"": "Object;_scX<,_shY<,_shX<,_scY<,_tX<,_tY<",
  ...
  transformCoordinate$1: function(point) {
    ...
    return new X.Coordinate(J.$add$ns(J.$add$ns(t3, t5.$mul(t4, this._shX)), this._tX), J.$add$ns(J.$add$ns(t2.$mul(t1, this._shY), t5.$mul(t4, this._scY)), this._tY));
  },
...
Box: {"": "Object;left>,top>,width>,height>",
  contains$1: function(_, point) {
    ...
    if (t3.$ge(t1, t2))
      if (t3.$le(t1, J.$add$ns(t2, this.width))) {
        t1 = point.y;
        t2 = this.top;
        t3 = J.getInterceptor$n(t1);
  ...
  $eq: function(_, other) {
    ...
    t1 = J.$eq(t1.get$left(other), this.left) && J.$eq(t1.get$top(other), this.top) && J.$eq(t1.get$width(other), this.width) && J.$eq(t1.get$height(other), this.height);
    return t1;
  },
  toString$0: function(_) {
    return "Location: " + H.S(new X.Coordinate(this.left, this.top)) + ", Size: " + H.S(new X.Size(this.width, this.height));
  },
  get$hashCode: function(_) {
    return X.Util_getHashCode([this.left, this.top, this.width, this.height]);
  }
},
...
Coordinate: {"": "Object;x>,y>",
  ...
  $add: function(_, other) {
    ...
    return new X.Coordinate(J.$add$ns(this.x, t1.get$x(other)), J.$add$ns(this.y, t1.get$y(other)));
  },
  $eq: function(_, other) {
    var t1;
    if (other == null)
      return false;
    t1 = J.getInterceptor$x(other);
    t1 = J.$eq(this.x, t1.get$x(other)) && J.$eq(this.y, t1.get$y(other));
    return t1;
  },
  toString$0: function(_) {
    return "{x:" + H.S(this.x) + ", y:" + H.S(this.y) + "}";
  },
  get$hashCode: function(_) {
    return X.Util_getHashCode([this.x, this.y]);
  },
  static: {
Coordinate_difference: function(a, b) {
  var t1 = J.getInterceptor$x(b);
  return new X.Vector(J.$sub$n(a.x, t1.get$x(b)), J.$sub$n(a.y, t1.get$y(b)));
}}
...
Vector: {"": "Coordinate;x,y",
  ...
  $add: function(_, other) {
    var t1 = J.getInterceptor$x(other);
    return new X.Vector(J.$add$ns(this.x, t1.get$x(other)), J.$add$ns(this.y, t1.get$y(other)));
  },
  $mul: function(_, magnitude) {
    return new X.Vector(J.$mul$n(this.x, magnitude), J.$mul$n(this.y, magnitude));
  }
}}],
...
CanvasUtil_drawImage: function(ctx, img, sourceBox, targetBox) {
  ...
  J.drawImageToRect$3$sourceRect$x(ctx, img, new W.Rect(targetBox.left, targetBox.top, targetBox.width, targetBox.height), new W.Rect(sourceBox.left, sourceBox.top, sourceBox.width, sourceBox.height));
}}],
...
ImageThing: {"": "Thing;",
  drawOverride$1: function(ctx) {
    ...
    if (t2.get$complete(t1) === true)
      ...
      t2 = new W._EventStreamSubscription(0, t1._liblib4$_target, t1._eventType, W._EventStreamSubscription__wrapZone(t2), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
    }
  },
  _doDraw$1: function(ctx) {
    J.drawImageToRect$2$x(ctx, this._image, new W.Rect(0, 0, this._width, this._height));
  },
...
MouseManager: {"": "Object;_liblib3$_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  _mouseMove$1: function(e) {
    ...
    items = B.Mouse_markMouseOver(t2, new X.Coordinate(t1.get$x(t1), t1.get$y(t1)));
  ...
  _mouseUp$1: function(e) {
    var t1, hits, thing;
    t1 = J.get$offset$x(e);
    hits = B.Mouse_markMouseOver(this._liblib3$_stage, new X.Coordinate(t1.get$x(t1), t1.get$y(t1)));
    hits.firstWhere$2$orElse;
  ...
  _startDrag$2: function(thing, e) {
    ...
    if (!args._canceled) {
      ...
      t1 = t1.get$client(e);
      this._dragCoordinate = new X.Coordinate(t1.get$x(t1), t1.get$y(t1));
    }
  },
  _windowMouseMove$1: function(e) {
    var t1, t2, newLoc, delta, t3;
    t1 = this._dragCoordinate;
    if (t1 != null) {
      t2 = J.get$client$x(e);
      newLoc = new X.Coordinate(t2.get$x(t2), t2.get$y(t2));
      delta = X.Coordinate_difference(newLoc, t1);
      t1 = this._draggingThing;
  ...
  MouseManager$_internal$1: function(_stage) {
    ...
    t2 = new W._EventStreamSubscription(0, t4._liblib4$_target, t4._eventType, W._EventStreamSubscription__wrapZone(t2), t4._useCapture);
    ...
    t5 = new W._EventStreamSubscription(0, t2._liblib4$_target, t2._eventType, W._EventStreamSubscription__wrapZone(t5), t2._useCapture);
    H.setRuntimeTypeInfo(t5, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t5._tryResume$0();
    t1 = t1.get$_liblib3$_canvas();
    t1.get$onMouseDown;
    t1 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_mousedown._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t5 = this.get$_mouseDown();
    t5 = new W._EventStreamSubscription(0, t1._liblib4$_target, t1._eventType, W._EventStreamSubscription__wrapZone(t5), t1._useCapture);
    ...
    t5 = new W._EventStreamSubscription(0, t3._liblib4$_target, t3._eventType, W._EventStreamSubscription__wrapZone(t5), t3._useCapture);
    ...
    t5 = new W._EventStreamSubscription(0, t4._liblib4$_target, t4._eventType, W._EventStreamSubscription__wrapZone(t5), t4._useCapture);
    ...
    t4 = new W._EventStreamSubscription(0, t5._liblib4$_target, t5._eventType, W._EventStreamSubscription__wrapZone(t4), t5._useCapture);
...
SpriteThing: {"": "ImageThing;startCoordinate,nextDelta,count,_frame,_image,_waitingOnLoad,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  _doDraw$1: function(ctx) {
    var t1, msPerFrame, theFrame, t2, sourceCoord;
    t1 = this.count;
    msPerFrame = C.JSInt_methods.$tdiv(1000, t1);
    theFrame = C.JSNumber_methods.$mod(C.JSNumber_methods.$tdiv(P.DateTime$_now().millisecondsSinceEpoch, msPerFrame), t1);
    t1 = this.startCoordinate;
    t2 = this.nextDelta;
    sourceCoord = t1.$add(t1, new X.Vector(J.$mul$n(t2.x, theFrame), J.$mul$n(t2.y, theFrame)));
    t2 = new X.Size(this._width, this._height);
    B.CanvasUtil_drawImage(ctx, this._image, new X.Box(sourceCoord.x, sourceCoord.y, t2.width, t2.height), null);
  },
  static: {
SpriteThing_SpriteThing$horizontalFromUrl: function(src, w, h, count, xDelta, start) {
  ...
  return new B.SpriteThing(start, new X.Vector(xDelta, 0), count, 0, img, false, t1, new X.EventHandle(P.StreamController_StreamController$broadcast(null, null, true, null), false), null, w, h, 1, false, null, null, P.LinkedHashMap_LinkedHashMap(null, null, null, X.Property, P.Object), P.LinkedHashMap_LinkedHashMap(null, null, null, X.Attachable, X.EventHandle), false);
}}
...
Stage: {"": "AttachableObject;_invalidatedEventHandle,_liblib3$_canvas<,rootThing<,_ctx,_propertyValues,_eventHandlers,_disposed",
  get$ctx: function() {
    if (this._disposed)
      H.throwExpression(new X.DisposedError("Invalid operation on disposed object"));
    if (this._ctx == null)
      this._ctx = J.get$context2D$x(this._liblib3$_canvas);
    return this._ctx;
  },
  draw$0: function() {
    var t1, t2, t3;
...
_BroadcastStream: {"": "_ControllerStream;_liblib1$_controller", $as_ControllerStream: null},

_BroadcastSubscription: {"": "_ControllerSubscription;_eventState@,_next@,_previous?,_liblib1$_controller,_liblib1$_onData,_onError,_onDone,_zone,_state,_liblib1$_pending",
...
_ControllerStream: {"": "_StreamImpl;",
  ...
  get$hashCode: function(_) {
    return (H.Primitives_objectHashCode(this._liblib1$_controller) ^ 892482866) >>> 0;
  },
  $eq: function(_, other) {
    var t1;
    if (other == null)
...
_ControllerSubscription: {"": "_BufferingStreamSubscription;_liblib1$_controller<",
  _onCancel$0: function() {
    this.get$_liblib1$_controller()._recordCancel$1(this);
  },
  _onPause$0: function() {
    this.get$_liblib1$_controller();
  },
  get$_onPause: function() {
...
_BufferingStreamSubscription: {"": "Object;_liblib1$_onData,_onError,_onDone,_zone<,_state,_liblib1$_pending",
  pause$1: function(_, resumeSignal) {
    ...
    if (t1 < 64 && this._liblib1$_pending != null) {
      t2 = this._liblib1$_pending;
      t2.cancelSchedule$0;
      if (t2._state === 1)
        t2._state = 3;
    }
  ...
  resume$0: function() {
    ...
    if (t1 >= 64) {
      ...
      t1 = this._state;
      if (t1 < 64)
        if ((t1 & 32) !== 0 && this._liblib1$_pending.lastPendingEvent != null)
          this._liblib1$_pending.schedule$1(this);
        else {
  ...
  cancel$0: function() {
    ...
    if ((t1 & 16) === 0) {
      this._state = (t1 | 16) >>> 0;
      this._onCancel$0();
      this._liblib1$_pending = null;
      this._state = (this._state & 4294967279) >>> 0;
    }
  },
  get$_mayResumeInput: function() {
    if (this._state < 64) {
      var t1 = this._liblib1$_pending;
  ...
  _addPending$1: function($event) {
    var pending, t1;
    pending = this._liblib1$_pending;
    if (pending == null) {
      pending = new P._StreamImplEvents(null, null, 0);
      this._liblib1$_pending = pending;
    }
  ...
  _sendData$1: function(data) {
    var t1 = this._state;
    this._state = (t1 | 16) >>> 0;
    this._zone.runUnaryGuarded$2(this._liblib1$_onData, data);
    this._state = (this._state & 4294967279) >>> 0;
...
_ForwardingStreamSubscription: {"": "_BufferingStreamSubscription;_stream,_subscription,_liblib1$_onData,_onError,_onDone,_zone,_state,_liblib1$_pending",
  _liblib1$_add$1: function(data) {
    if ((this._state & 2) !== 0)
      return;
...
_LinkedHashMap: {"": "Object;_liblib0$_length,_strings,_nums,_rest,_first,_last,_modifications",
  ...
  _unlinkCell$1: function(cell) {
    ...
    if (previous == null)
      ...
      previous._liblib0$_next = next;
    if (next == null)
      this._last = previous;
    else
      next._liblib0$_previous = previous;
    this._liblib0$_length = this._liblib0$_length - 1;
    this._modifications = this._modifications + 1 & 67108863;
  },
  _computeHashCode$1: function(key) {
...
LinkedHashMapCell: {"": "Object;_key<,_liblib0$_value@,_liblib0$_next<,_liblib0$_previous<"},
  ...
  moveNext$0: function() {
    ...
    if (this._modifications !== t1._modifications)
      ...
      if (t1 == null) {
        ...
        this._cell = this._cell._liblib0$_next;
        return true;
      }
    }
  }
...
_EventStream: {"": "Stream;_liblib4$_target,_eventType,_useCapture",
  listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
    var t1 = new W._EventStreamSubscription(0, this._liblib4$_target, this._eventType, W._EventStreamSubscription__wrapZone(onData), this._useCapture);
...
_ElementEventStreamImpl: {"": "_EventStream;_liblib4$_target,_eventType,_useCapture", $as_EventStream: null},
...
_EventStreamSubscription: {"": "StreamSubscription;_pauseCount,_liblib4$_target,_eventType,_onData,_useCapture",
  ...
  _tryResume$0: function() {
    ...
    if (t1 != null && this._pauseCount <= 0)
      J.$$dom_addEventListener$3$x(this._liblib4$_target, this._eventType, t1, this._useCapture);
  },
  _unlisten$0: function() {
    var t1 = this._onData;
    if (t1 != null)
      J.$$dom_removeEventListener$3$x(this._liblib4$_target, this._eventType, t1, this._useCapture);
  },
...
Point: {"": "Object;x>,y>",
  ...
  $add: function(_, other) {
    var t1 = J.getInterceptor$x(other);
    return new W.Point(J.$add$ns(this.x, t1.get$x(other)), J.$add$ns(this.y, t1.get$y(other)));
  },
  $sub: function(_, other) {
    var t1 = J.getInterceptor$x(other);
    return new W.Point(J.$sub$n(this.x, t1.get$x(other)), J.$sub$n(this.y, t1.get$y(other)));
  },
  $mul: function(_, factor) {
    return new W.Point(J.$mul$n(this.x, factor), J.$mul$n(this.y, factor));
  },
  toInt$0: function(_) {
...
DraggerDemo_DraggerDemo: function(canvas) {
  var image, tx, t1, t2, rootPanel, stage;
  image = B.SpriteThing_SpriteThing$horizontalFromUrl("disasteroids2_master.png", 28, 28, 16, 29, new X.Coordinate(35, 354));
...
init.globalFunctions._demoIsolate$closure = R._demoIsolate$closure = new R.Closure$_demoIsolate(R._demoIsolate, "_demoIsolate$closure");
...
function dart_precompiled($collectedClasses) {
  ...
  function BoundClosure(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  }
  ...
  function BoundClosure$1(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Box.prototype = $desc;
  Box.prototype.get$left = function(receiver) {
    return this.left;
  };
  Box.prototype.get$top = function(receiver) {
    return this.top;
  };
  Box.prototype.get$width = function(receiver) {
    return this.width;
  };
  Box.prototype.get$height = function(receiver) {
    return this.height;
  };
  ...
  FutureValue.builtin$cls = "FutureValue";
  if (!"name" in FutureValue)
    FutureValue.name = "FutureValue";
  $desc = $collectedClasses.FutureValue;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FutureValue.prototype = $desc;
  function FutureValueResult(value, error, stackTrace, _outputSerializer) {
    this.value = value;
    this.error = error;
    this.stackTrace = stackTrace;
    this._outputSerializer = _outputSerializer;
  }
  FutureValueResult.builtin$cls = "FutureValueResult";
  if (!"name" in FutureValueResult)
    FutureValueResult.name = "FutureValueResult";
  $desc = $collectedClasses.FutureValueResult;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FutureValueResult.prototype = $desc;
  FutureValueResult.prototype.get$value = function(receiver) {
    return this.value;
  };
  FutureValueResult.prototype.get$error = function(receiver) {
    return this.error;
  };
  FutureValueResult.prototype.get$stackTrace = function() {
    return this.stackTrace;
  };
  function SendPortValue() {
  }
  SendPortValue.builtin$cls = "SendPortValue";
  if (!"name" in SendPortValue)
    SendPortValue.name = "SendPortValue";
  $desc = $collectedClasses.SendPortValue;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SendPortValue.prototype = $desc;
  function SendPortValue_getFuture_closure(this_0) {
    this.this_0 = this_0;
  }
  SendPortValue_getFuture_closure.builtin$cls = "SendPortValue_getFuture_closure";
  if (!"name" in SendPortValue_getFuture_closure)
    SendPortValue_getFuture_closure.name = "SendPortValue_getFuture_closure";
  $desc = $collectedClasses.SendPortValue_getFuture_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SendPortValue_getFuture_closure.prototype = $desc;
  function SendValuePort(_func, inputDeserializer, outputSerializer) {
    this._func = _func;
    this.inputDeserializer = inputDeserializer;
    this.outputSerializer = outputSerializer;
  }
  SendValuePort.builtin$cls = "SendValuePort";
  if (!"name" in SendValuePort)
    SendValuePort.name = "SendValuePort";
  $desc = $collectedClasses.SendValuePort;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SendValuePort.prototype = $desc;
  function SendValuePort_closure(TOutput_0, this_1) {
    this.TOutput_0 = TOutput_0;
    this.this_1 = this_1;
  }
  SendValuePort_closure.builtin$cls = "SendValuePort_closure";
  if (!"name" in SendValuePort_closure)
    SendValuePort_closure.name = "SendValuePort_closure";
  $desc = $collectedClasses.SendValuePort_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SendValuePort_closure.prototype = $desc;
  function CanvasThing(_children, background, _transforms, _invalidatedEventHandle, _cacheCanvas, _width, _height, _alpha, _cacheEnabled, _lastDrawTime, _parent, _propertyValues, _eventHandlers, _disposed) {
  ...
  CanvasThing.builtin$cls = "CanvasThing";
  if (!"name" in CanvasThing)
    CanvasThing.name = "CanvasThing";
  $desc = $collectedClasses.CanvasThing;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasThing.prototype = $desc;
  function ImageThing() {
  }
  ImageThing.builtin$cls = "ImageThing";
  if (!"name" in ImageThing)
    ImageThing.name = "ImageThing";
  $desc = $collectedClasses.ImageThing;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ImageThing.prototype = $desc;
  ...
  function MouseManager(_liblib3$_stage, _mouseDownThing, _draggingThing, _dragCoordinate) {
    this._liblib3$_stage = _liblib3$_stage;
  ...
  function PanelThing(_children) {
    this._children = _children;
  }
  PanelThing.builtin$cls = "PanelThing";
  if (!"name" in PanelThing)
    PanelThing.name = "PanelThing";
  $desc = $collectedClasses.PanelThing;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PanelThing.prototype = $desc;
  PanelThing.prototype.get$_children = function(receiver) {
  ...
  function SpriteThing(startCoordinate, nextDelta, count, _frame, _image, _waitingOnLoad, _transforms, _invalidatedEventHandle, _cacheCanvas, _width, _height, _alpha, _cacheEnabled, _lastDrawTime, _parent, _propertyValues, _eventHandlers, _disposed) {
    this.startCoordinate = startCoordinate;
    this.nextDelta = nextDelta;
    this.count = count;
    this._frame = _frame;
    this._image = _image;
    this._waitingOnLoad = _waitingOnLoad;
    this._transforms = _transforms;
    this._invalidatedEventHandle = _invalidatedEventHandle;
    this._cacheCanvas = _cacheCanvas;
    this._width = _width;
  ...
  SpriteThing.builtin$cls = "SpriteThing";
  if (!"name" in SpriteThing)
    SpriteThing.name = "SpriteThing";
  $desc = $collectedClasses.SpriteThing;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SpriteThing.prototype = $desc;
  function Stage(_invalidatedEventHandle, _liblib3$_canvas, rootThing, _ctx, _propertyValues, _eventHandlers, _disposed) {
    this._invalidatedEventHandle = _invalidatedEventHandle;
    this._liblib3$_canvas = _liblib3$_canvas;
  ...
  Stage.prototype.get$_liblib3$_canvas = function() {
  ...
  function _BroadcastStream(_liblib1$_controller) {
    this._liblib1$_controller = _liblib1$_controller;
  }
  ...
  function _BroadcastSubscription(_eventState, _next, _previous, _liblib1$_controller, _liblib1$_onData, _onError, _onDone, _zone, _state, _liblib1$_pending) {
    ...
    this._zone = _zone;
    this._state = _state;
    this._liblib1$_pending = _liblib1$_pending;
  }
  ...
  function Bound__onPause__BroadcastSubscription(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  function Bound__onResume__BroadcastSubscription(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  function Bound__completeError__Future(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  function _ControllerSubscription(_liblib1$_controller) {
    this._liblib1$_controller = _liblib1$_controller;
  }
  ...
  _ControllerSubscription.prototype.get$_liblib1$_controller = function() {
    return this._liblib1$_controller;
  };
  function Bound__onPause__ControllerSubscription(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  function Bound__onResume__ControllerSubscription(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  function _BufferingStreamSubscription(_liblib1$_onData, _onError, _onDone, _zone, _state, _liblib1$_pending) {
    this._liblib1$_onData = _liblib1$_onData;
    this._onError = _onError;
    this._onDone = _onDone;
    this._zone = _zone;
  ...
  function Bound__onPause__BufferingStreamSubscription(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  function Bound__onResume__BufferingStreamSubscription(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  function _ForwardingStreamSubscription(_stream, _subscription, _liblib1$_onData, _onError, _onDone, _zone, _state, _liblib1$_pending) {
  ...
  function Bound__onPause__ForwardingStreamSubscription(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  function Bound__onResume__ForwardingStreamSubscription(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  function Bound__handleDone__ForwardingStreamSubscription(_self, _target, _receiver, _liblib5$_name) {
    this._self = _self;
    this._target = _target;
    this._receiver = _receiver;
    this._liblib5$_name = _liblib5$_name;
  ...
  function _MapStream(_transform, _liblib1$_source) {
    this._transform = _transform;
    this._liblib1$_source = _liblib1$_source;
  }
  ...
  function LinkedHashMapCell(_key, _liblib0$_value, _liblib0$_next, _liblib0$_previous) {
    this._key = _key;
    this._liblib0$_value = _liblib0$_value;
    this._liblib0$_next = _liblib0$_next;
    this._liblib0$_previous = _liblib0$_previous;
  }
  ...
  LinkedHashMapCell.prototype.get$_liblib0$_next = function() {
    return this._liblib0$_next;
  };
  LinkedHashMapCell.prototype.get$_liblib0$_previous = function() {
    return this._liblib0$_previous;
  };
  ...
  function _EventStream(_liblib4$_target, _eventType, _useCapture) {
  ...
  function _ElementEventStreamImpl(_liblib4$_target, _eventType, _useCapture) {
    this._liblib4$_target = _liblib4$_target;
    this._eventType = _eventType;
    this._useCapture = _useCapture;
  }
  ...
  function _EventStreamSubscription(_pauseCount, _liblib4$_target, _eventType, _onData, _useCapture) {
  ...
  function IsolateUnhandledException(message, source, stackTrace) {
    this.message = message;
    this.source = source;
    this.stackTrace = stackTrace;
  }
  IsolateUnhandledException.builtin$cls = "IsolateUnhandledException";
  if (!"name" in IsolateUnhandledException)
    IsolateUnhandledException.name = "IsolateUnhandledException";
  $desc = $collectedClasses.IsolateUnhandledException;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IsolateUnhandledException.prototype = $desc;
  IsolateUnhandledException.prototype.get$stackTrace = function() {
    return this.stackTrace;
  };
  ...
  function DraggerDemo(_canvas, _stage, _tx, _demoMapper, _mouseLocation, _frameRequested, _thing) {
    this._canvas = _canvas;
    this._stage = _stage;
    this._tx = _tx;
    this._demoMapper = _demoMapper;
    this._mouseLocation = _mouseLocation;
    this._frameRequested = _frameRequested;
    this._thing = _thing;
  }
  DraggerDemo.builtin$cls = "DraggerDemo";
  if (!"name" in DraggerDemo)
    DraggerDemo.name = "DraggerDemo";
  $desc = $collectedClasses.DraggerDemo;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DraggerDemo.prototype = $desc;
  function DraggerDemo$_internal_closure(this_0) {
    this.this_0 = this_0;
  }
  DraggerDemo$_internal_closure.builtin$cls = "DraggerDemo$_internal_closure";
  if (!"name" in DraggerDemo$_internal_closure)
    DraggerDemo$_internal_closure.name = "DraggerDemo$_internal_closure";
  $desc = $collectedClasses.DraggerDemo$_internal_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DraggerDemo$_internal_closure.prototype = $desc;
  function _DemoValue(_sendPort, inputSerializer, outputDeserializer, _input, _future, _output, _pending, _outputChangedHandle, _inputChangedHandle, _errorHandle) {
    this._sendPort = _sendPort;
    this.inputSerializer = inputSerializer;
    this.outputDeserializer = outputDeserializer;
    this._input = _input;
    this._future = _future;
    this._output = _output;
    this._pending = _pending;
    this._outputChangedHandle = _outputChangedHandle;
    this._inputChangedHandle = _inputChangedHandle;
    this._errorHandle = _errorHandle;
  }
  _DemoValue.builtin$cls = "_DemoValue";
  if (!"name" in _DemoValue)
    _DemoValue.name = "_DemoValue";
  $desc = $collectedClasses._DemoValue;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _DemoValue.prototype = $desc;
  function _demoIsolate_closure() {
  }
  _demoIsolate_closure.builtin$cls = "_demoIsolate_closure";
  if (!"name" in _demoIsolate_closure)
    _demoIsolate_closure.name = "_demoIsolate_closure";
  $desc = $collectedClasses._demoIsolate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _demoIsolate_closure.prototype = $desc;
