...
function dart_precompiled($collectedClasses) {
  ...
  function MouseManager(_bot_retained$_stage, _mouseDownThing, _draggingThing, _dragCoordinate) {
    this._bot_retained$_stage = _bot_retained$_stage;
  ...
  function Stage(_invalidatedEventHandle, _bot_retained$_canvas, rootThing, _ctx, _propertyValues, _eventHandlers, _disposed) {
    this._invalidatedEventHandle = _invalidatedEventHandle;
    this._bot_retained$_canvas = _bot_retained$_canvas;
  ...
  Stage.prototype.get$_bot_retained$_canvas = function() {
    return this._bot_retained$_canvas;
  };
  ...
  function _BroadcastSubscription(_eventState, _next, _previous, _async$_controller, _async$_onData, _onError, _onDone, _zone, _state, _async$_pending) {
  ...
  function _BufferingStreamSubscription(_async$_onData, _onError, _onDone, _zone, _state, _async$_pending) {
    this._async$_onData = _async$_onData;
    this._onError = _onError;
    this._onDone = _onDone;
    this._zone = _zone;
  ...
  function _ForwardingStreamSubscription(_stream, _subscription, _async$_onData, _onError, _onDone, _zone, _state, _async$_pending) {
