...
$$.Closure$_demoIsolate = {"": "Closure;call$0,$name"};
...
IsolateNatives_spawnFunction: function(topLevelFunction) {
  ...
  if ($name == null)
    throw $.wrapException(new $.UnsupportedError("only top-level functions can be spawned."));
...
IsolateNatives_spawn: function(functionName, uri, isLight) {
  ...
  signalReply = new $._NativeJsSendPort(port, $globalState.currentContext.id);
  ...
  return $._BufferingSendPort$($globalState.currentContext.id, completer.future);
},
...
IsolateNatives__startWorker: function(functionName, uri, replyPort) {
  ...
  if ($globalState.isWorker === true) {
    t1 = $globalState.mainManager;
    t2 = $._serializeMessage($.makeLiteralMap(["command", "spawn-worker", "functionName", functionName, "uri", uri, "replyPort", replyPort]));
    t1.postMessage$1;
    self.postMessage(t2);
  } else
...
IsolateNatives__startNonWorker: function(functionName, uri, replyPort) {
  ...
  t2 = $._IsolateContext$();
  t1.enqueue$3;
  t1.events._add$1(new $._IsolateEvent(t2, new $.IsolateNatives__startNonWorker_closure(functionName, replyPort), "nonworker start"));
},
...
_BufferingSendPort: {"": "_BaseSendPort;_id<,_port?,_futurePort<,pending@,_isolateId",
  send$2: function(message, replyTo) {
    ...
    if (t1 != null)
      ...
      this.pending.push($.makeLiteralMap(["message", message, "replyTo", replyTo]));
  },
  send$1: function(message) {
    return this.send$2(message, null);
  },
...
_BufferingSendPort_closure: {"": "Closure;this_0",
  call$1: function(p) {
    ...
    t1 = this.this_0;
    t1.set$_port(p);
    for (t2 = t1.get$pending(), t2.get$iterator, t2 = new $.ListIterator(t2, t2.length, 0, null); t2.moveNext$0();) {
      item = t2._current;
...
_PendingSendPortFinder: {"": "_MessageTraverser;ports,_visited",
  ...
  visitSendPort$1: function(port) {
    if (typeof port === "object" && port !== null && !!$.getInterceptor(port).$is_BufferingSendPort && port._port == null)
...
Box: {"": "Object;left>,top>,width>,height>",
  ...
  $eq: function(_, other) {
    ...
    if (!t1) {
      ...
      t1 = $.$eq(t1.get$left(other), this.left) && $.$eq(t1.get$top(other), this.top) && $.$eq(t1.get$width(other), this.width) && $.$eq(t1.get$height(other), this.height);
    } else
      t1 = false;
    return t1;
  },
...
["bot_async", "package:bot/bot_async.dart", , {
FutureValue: {"": "Object;",
  ...
  get$error: function(_) {
    return new $._BroadcastStream(this._errorHandle._controller);
  },
  ...
  get$_futureException: function() {
    return new $.BoundClosure$1(this, "_futureException$1", null);
  },
  ...
  get$_futureCompleted: function() {
    return new $.BoundClosure$1(this, "_futureCompleted$1", null);
  }
},
...
FutureValueResult: {"": "Object;value>,error>,stackTrace<,_outputSerializer",
  ...
  $eq: function(_, other) {
    ...
    if (!t1) {
      t1 = $.getInterceptor$x(other);
      t1 = $.$eq(t1.get$value(other), this.value) && $.$eq(t1.get$error(other), this.error) && $.$eq(other.get$stackTrace(), this.stackTrace);
    } else
      t1 = false;
    return t1;
  },
  get$hashCode: function(_) {
    return $.Util_getHashCode([this.value, this.error, this.stackTrace]);
  },
  _serialize$1: function(output) {
    return output;
  },
  static: {
"": "FutureValueResult__valueKey,FutureValueResult__errorKey,FutureValueResult__stackTraceKey",
FutureValueResult_FutureValueResult$fromMap: function(value) {
  var ex, t1, t2;
  $._metaRequireArgumentNotNullOrEmpty("value");
  $.requireArgument($.FutureValueResult_isMyMap(value), "value", null);
  ex = value.$index(value, "error");
  if (ex != null) {
    t1 = new $.FutureValueResult(null, ex, value.$index(value, "stackTrace"), null);
    $._metaRequireArgumentNotNullOrEmpty("error");
    if (t1.error == null) {
      t2 = new $.NullArgumentError("error", "cannot be null", null);
      t2.DetailedArgumentError$2("error", "cannot be null");
      $.throwExpression(t2);
    }
    return t1;
  } else
    return new $.FutureValueResult(value.$index(value, "value"), null, null, null);
},

FutureValueResult_isMyMap: function(value) {
  return value.get$length(value) === 3 && value.containsKey$1("value") && value.containsKey$1("error") && value.containsKey$1("stackTrace");
}}
...
SendPortValue: {"": "FutureValue;",
  ...
  get$__futureCompleted: function() {
    return new $.BoundClosure$1(this, "__futureCompleted$1", null);
  },
  _sendValueResultCompleted$1: function(value) {
    var t1 = value.error;
    if (t1 != null)
      this._completeException$2(t1, value.stackTrace);
    else
      this._complete$1(value.value);
  },
  _complete$1: function(rawValue) {
    var c = this._completer;
    this._completer = null;
    c.complete$1(c, this._deserializer$1(rawValue));
  },
...
SendValuePort: {"": "Object;_func,inputDeserializer,outputSerializer<",
  ...
  SendValuePort$3$inputDeserializer$outputSerializer: function(_func, inputDeserializer, outputSerializer) {
    var t1 = $._Isolate_port();
    t1.receive$1;
    t1._callback = new $.SendValuePort_closure(this);
  },
  static: {
...
SendValuePort_closure: {"": "Closure;this_0",
  call$2: function(rawValue, reply) {
    ...
    try {
      ...
      _message = new $.FutureValueResult(output, null, null, t1.get$outputSerializer());
    } catch (exception) {
      t1 = $.unwrapException(exception);
      ex = t1;
      ...
      _message0 = new $.FutureValueResult(null, exString, stackString, null);
      $._metaRequireArgumentNotNullOrEmpty("error");
      if (_message0.error == null) {
        t1 = new $.NullArgumentError("error", "cannot be null", null);
...
CanvasUtil_drawImage: function(ctx, img, sourceBox, targetBox) {
  ...
  $.drawImageToRect$3$sourceRect$x(ctx, img, new $.Rect(targetBox.left, targetBox.top, targetBox.width, targetBox.height), new $.Rect(sourceBox.left, sourceBox.top, sourceBox.width, sourceBox.height));
}}],
...
ImageThing: {"": "Thing;",
  drawOverride$1: function(ctx) {
    ...
    if (t2.get$complete(t1) === true)
      ...
      t1 = t2.get$onLoad(t1);
      new $._EventStreamSubscription(0, t1._liblib5$_target, t1._eventType, this.get$_onImageLoad(), t1._useCapture)._tryResume$0();
    }
  },
  _doDraw$1: function(ctx) {
    $.drawImageToRect$2$x(ctx, this._image, new $.Rect(0, 0, this._width, this._height));
  },
  _onImageLoad$1: function($event) {
    this.invalidateDraw$0();
  },
  get$_onImageLoad: function() {
    return new $.BoundClosure$1(this, "_onImageLoad$1", null);
  }
},
...
MouseManager: {"": "Object;_liblib0$_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  _mouseMove$1: function(e) {
    var t1, t2, items, cursor, args;
    t1 = $.get$offset$x(e);
    t2 = this._liblib0$_stage;
  ...
  _mouseUp$1: function(e) {
    var t1, thing;
    t1 = $.get$offset$x(e);
    thing = $.firstWhere$2$orElse$ax($.Mouse_markMouseOver(this._liblib0$_stage, new $.Coordinate(t1.get$x(t1), t1.get$y(t1))), new $.MouseManager__mouseUp_closure(), new $.MouseManager__mouseUp_closure0());
    if (thing != null) {
  ...
  _mouseDown$1: function(e) {
    var t1, t;
    t1 = $.get$offset$x(e);
    for (t1 = $.get$iterator$ax($.Mouse_markMouseOver(this._liblib0$_stage, new $.Coordinate(t1.get$x(t1), t1.get$y(t1)))); t1.moveNext$0() === true;) {
      t = t1.get$current();
  ...
  MouseManager$_internal$1: function(_stage) {
    var t1, t2, t3, t4;
    t1 = this._liblib0$_stage;
    t2 = t1.get$_liblib0$_canvas();
    t2.get$onMouseMove;
    ...
    new $._EventStreamSubscription(0, t2._liblib5$_target, t2._eventType, this.get$_mouseMove(), t2._useCapture)._tryResume$0();
    t2 = t1.get$_liblib0$_canvas();
    t2.get$onMouseOut;
    $.EventStreamProvider_mouseout.forTarget$2$useCapture;
    t2 = new $._EventStream(t2, $.EventStreamProvider_mouseout._eventType, false);
    new $._EventStreamSubscription(0, t2._liblib5$_target, t2._eventType, this.get$_mouseOut(), t2._useCapture)._tryResume$0();
    t2 = t1.get$_liblib0$_canvas();
    t2.get$onMouseUp;
    ...
    new $._EventStreamSubscription(0, t2._liblib5$_target, t2._eventType, this.get$_mouseUp(), t2._useCapture)._tryResume$0();
    t1 = t1.get$_liblib0$_canvas();
    t1.get$onMouseDown;
    ...
    new $._EventStreamSubscription(0, t1._liblib5$_target, t1._eventType, this.get$_mouseDown(), t1._useCapture)._tryResume$0();
    t3 = new $._EventStream(window, t3, false);
    new $._EventStreamSubscription(0, t3._liblib5$_target, t3._eventType, this.get$_windowMouseMove(), t3._useCapture)._tryResume$0();
    t4 = new $._EventStream(window, t4, false);
    new $._EventStreamSubscription(0, t4._liblib5$_target, t4._eventType, this.get$_windowMouseUp(), t4._useCapture)._tryResume$0();
    t4 = window;
    $.EventStreamProvider_blur.forTarget$2$useCapture;
    t4 = new $._EventStream(t4, $.EventStreamProvider_blur._eventType, false);
    new $._EventStreamSubscription(0, t4._liblib5$_target, t4._eventType, this.get$_windowBlur(), t4._useCapture)._tryResume$0();
  },
  static: {
...
SpriteThing: {"": "ImageThing;startCoordinate,nextDelta,count,_frame,_image,_waitingOnLoad,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  _doDraw$1: function(ctx) {
    ...
    t2 = $.$tdiv$n($.DateTime$_now().millisecondsSinceEpoch, msPerFrame);
    if (typeof t2 !== "number")
      throw t2.$mod();
    t1 = $.JSNumber_methods.$mod(t2, t1);
    t2 = this.startCoordinate;
    t3 = this.nextDelta;
    sourceCoord = t2.$add(t2, new $.Vector($.$mul$n(t3.x, t1), $.$mul$n(t3.y, t1)));
    t1 = new $.Size(this._width, this._height);
    $.CanvasUtil_drawImage(ctx, this._image, new $.Box(sourceCoord.x, sourceCoord.y, t1.width, t1.height), null);
  },
  static: {
SpriteThing_SpriteThing$horizontalFromUrl: function(src, w, h, count, xDelta, start) {
  return new $.SpriteThing(start, new $.Vector(xDelta, 0), count, 0, $.ImageElement_ImageElement(null, src, null), false, $.List_List(null), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), null, w, h, 1, false, null, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
}}

},

Stage: {"": "AttachableObject;_invalidatedEventHandle,_liblib0$_canvas<,rootThing<,_ctx,_propertyValues,_eventHandlers,_disposed",
  get$ctx: function() {
    if (this._disposed)
      $.throwExpression(new $.DisposedError("Invalid operation on disposed object"));
    if (this._ctx == null)
      this._ctx = $.get$context2D$x(this._liblib0$_canvas);
    return this._ctx;
  },
  draw$0: function() {
    var t1, t2, t3;
...
_BroadcastSubscription: {"": "_ControllerSubscription;_eventState@,_liblib1$_next@,_liblib1$_previous@,_liblib1$_controller,_liblib1$_onData,_onError,_onDone,_zone,_state,_liblib1$_pending",
...
_BroadcastStreamController: {"": "Object;_state@,_liblib1$_next@,_liblib1$_previous@",
  get$stream: function(_) {
    return new $._BroadcastStream(this);
  },
  get$hasListener: function() {
    return this._liblib1$_next !== this;
  },
  ...
  _removeListener$1: function(subscription) {
    var previous, next;
    previous = subscription.get$_liblib1$_previous();
    next = subscription.get$_liblib1$_next();
    previous.set$_liblib1$_next(next);
    next.set$_liblib1$_previous(previous);
    subscription.set$_liblib1$_previous(subscription);
    subscription.set$_liblib1$_next(subscription);
  },
...
_SyncBroadcastStreamController: {"": "_BroadcastStreamController;_onListen,_onCancel,_state,_liblib1$_next,_liblib1$_previous,_addStreamState,_doneFuture",
...
_AsyncBroadcastStreamController: {"": "_BroadcastStreamController;_onListen,_onCancel,_state,_liblib1$_next,_liblib1$_previous,_addStreamState,_doneFuture",
  _sendData$1: function(data) {
    var link;
    for (link = this._liblib1$_next; link !== this; link = link.get$_liblib1$_next())
  ...
  _sendDone$0: function() {
    var link = this._liblib1$_next;
    if (link !== this)
      for (; link !== this; link = link.get$_liblib1$_next())
...
_ListQueueIterator: {"": "Object;_queue,_end,_modificationCount,_position,_liblib3$_current",
  get$current: function() {
    return this._liblib3$_current;
  },
  moveNext$0: function() {
...
CanvasRenderingContext2D: {"": "CanvasRenderingContext;globalAlpha%",
...
ImageElement: {"": "_HTMLElement;complete=,height%,src},width%,x=,y="},

InputElement: {"": "_HTMLElement;height%,src},value=,width%", $isElement: true, $asElement: null, $isEventTarget: true, $asEventTarget: null},
...
DraggerDemo: {"": "Object;_canvas,_stage,_tx,_demoMapper,_mouseLocation,_frameRequested,_thing",
  ...
  get$_onStageInvalidated: function() {
    return new $.BoundClosure$1(this, "_onStageInvalidated$1", null);
  },
  ...
  get$_onDrag: function() {
    return new $.BoundClosure$1(this, "_onDrag$1", null);
  },
  _onFrame$1: function(highResTime) {
    ...
    t1 = this._demoMapper;
    inputText = " Input: " + $.S(t1._input);
    outputText = "Output: " + $.S(t1._output);
    t1 = this._canvas;
    t2 = $.getInterceptor$x(t1);
    bottom = t2.get$height(t1);
    t2.get$width(t1);
    t1 = $.getInterceptor$n(bottom);
    ctx.fillText(inputText, 10, t1.$sub(bottom, 40));
    ctx.fillText(outputText, 10, t1.$sub(bottom, 20));
    ctx.restore();
    this._frameRequested = false;
    this.requestFrame$0();
  },
  get$_onFrame: function() {
    return new $.BoundClosure$1(this, "_onFrame$1", null);
  },
  DraggerDemo$_internal$4: function(_canvas, _stage, _tx, _thing) {
    var t1;
    new $._BroadcastStream(this._demoMapper._outputChangedHandle._controller).listen$1(new $.DraggerDemo$_internal_closure(this));
    t1 = this._stage;
    new $._BroadcastStream(t1._invalidatedEventHandle._controller).listen$1(this.get$_onStageInvalidated());
    $.MouseManager_MouseManager(t1);
    t1 = this._thing;
    $.MouseManager__setBoolProp(t1, $.get$MouseManager__isDraggableProperty(), true);
    t1._getStream$1($.get$MouseManager__dragEvent()).listen$1(this.get$_onDrag());
  },
  static: {
DraggerDemo_DraggerDemo: function(canvas) {
  var image, tx, rootPanel, stage;
  image = $.SpriteThing_SpriteThing$horizontalFromUrl("disasteroids2_master.png", 28, 28, 16, 29, new $.Coordinate(35, 354));
  $.MouseManager_setCursor(image, "pointer");
  ...
  stage = new $.Stage(new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), canvas, rootPanel, null, new $.HashMap(0, null, null, null, null), new $.HashMap(0, null, null, null, null), false);
  stage.rootThing.registerParent$1(stage);
  return $.DraggerDemo$_internal(canvas, stage, tx, image);
},

DraggerDemo$_internal: function(_canvas, _stage, _tx, _thing) {
  var t1 = new $.DraggerDemo(_canvas, _stage, _tx, new $._DemoValue($.IsolateNatives_spawnFunction($._demoIsolate$closure), null, null, null, null, null, null, null, false, new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false), new $.EventHandle($.StreamController_StreamController$broadcast(null, null, true), false)), null, false, _thing);
...
_demoIsolate_closure: {"": "Closure;",
  call$1: function(input) {
    ...
    otherMs = $.DateTime$_now().millisecondsSinceEpoch;
    if (typeof otherMs !== "number")
      return this.call$1$bailout(1, input, otherMs);
    do {
      t1 = new $.DateTime(Date.now(), false);
      if (t1.date === void 0)
        t1.date = new Date(t1.millisecondsSinceEpoch);
      t1.date;
      t1 = $.$mul$n($.$sub$n(t1.millisecondsSinceEpoch, otherMs), 1000);
      if (typeof t1 !== "number")
        throw $.iae(t1);
    } while ($.JSNumber_methods.$tdiv(new $.Duration(0 + t1 + 0)._duration, 1000000) < 1);
    t1 = $.getInterceptor$asx(input);
    coord = new $.Coordinate(t1.$index(input, 0), t1.$index(input, 1));
    return $.$mul$n(coord.x, coord.y);
  },
  call$1$bailout: function(state0, input, otherMs) {
    var t1, coord;
    do {
      t1 = new $.DateTime(Date.now(), false);
      if (t1.date === void 0)
...
$._demoIsolate$closure = new $.Closure$_demoIsolate($._demoIsolate, "_demoIsolate$closure");
