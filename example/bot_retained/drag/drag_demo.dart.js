...
IsolateNatives__startNonWorker_closure: {"": "Closure;functionName_0,replyPort_1",
  call$0: function() {
    $.IsolateNatives__startIsolate($.IsolateNatives__getJSFunctionFromName(this.functionName_0), this.replyPort_1);
  }
},
...
IsolateNatives_spawnFunction: function(topLevelFunction) {
  var $name = $.IsolateNatives__getJSFunctionName(topLevelFunction);
  if ($name == null)
...
IsolateNatives_spawn: function(functionName, uri, isLight) {
  ...
  port.receive$1(new $.IsolateNatives_spawn_closure(completer, port));
  ...
  return $._BufferingSendPort$($._globalState().currentContext.id, completer.future);
},
...
IsolateNatives__startNonWorker: function(functionName, uri, replyPort) {
  $._globalState().topEventLoop.enqueue$3($._IsolateContext$(), new $.IsolateNatives__startNonWorker_closure(functionName, replyPort), "nonworker start");
},
...
SendPortValue: {"": "FutureValue;",
  ...
  _sendValueResultCompleted$1: function(value) {
    if (value.get$isException())
      this._completeException$2(value.error, value.stackTrace);
    else
...
SendValuePort: {"": "Object;_func,inputDeserializer,outputSerializer<",
  ...
  SendValuePort$3$inputDeserializer$outputSerializer: function(_func, inputDeserializer, outputSerializer) {
    $.port().receive$1(new $.SendValuePort_closure(this));
  }
},
...
FutureValueResult_FutureValueResult$fromMap: function(value) {
  ...
  if (ex != null)
    return $.FutureValueResult$fromException(ex, value.$index(value, "stackTrace"));
  else
    return $.FutureValueResult$(value.$index(value, "value"), null);
},
...
ImageThing: {"": "Thing;",
  drawOverride$1: function(ctx) {
    ...
    if (t2.get$complete(t1) === true)
      ...
      t2.get$onLoad(t1).listen$1(this.get$_onImageLoad());
    }
  },
...
MouseManager: {"": "Object;_liblib1$_stage,_mouseDownThing,_draggingThing,_dragCoordinate",
  ...
  _mouseOut$1: function(e) {
    ...
    $.get$MouseManager__mouseOutEvent().fireEvent$2(this._liblib1$_stage, $.C_EventArgs);
  ...
  _updateStageCursor$1: function(cursor) {
    $.get$MouseManager_cursorProperty().set$2(this._liblib1$_stage, cursor);
  },
  _updateMouseLocation$1: function(value) {
    return $.Mouse_markMouseOver(this._liblib1$_stage, value);
  },
  ...
  MouseManager$_internal$1: function(_stage) {
    var t1 = this._liblib1$_stage;
    $.get$onMouseMove$x(t1.get$_liblib1$_canvas()).listen$1(this.get$_mouseMove());
    $.get$onMouseOut$x(t1.get$_liblib1$_canvas()).listen$1(this.get$_mouseOut());
    $.get$onMouseUp$x(t1.get$_liblib1$_canvas()).listen$1(this.get$_mouseUp());
    $.get$onMouseDown$x(t1.get$_liblib1$_canvas()).listen$1(this.get$_mouseDown());
...
SpriteThing: {"": "ImageThing;startCoordinate,nextDelta,count,_frame,_image,_waitingOnLoad,_transforms,_invalidatedEventHandle,_cacheCanvas,_width,_height,_alpha,_cacheEnabled,_lastDrawTime,_parent,_propertyValues,_eventHandlers,_disposed",
  _doDraw$1: function(ctx) {
    var t1, msPerFrame, t2, t3, t4;
    t1 = this.count;
    msPerFrame = $.JSInt_methods.$tdiv(1000, t1);
    t2 = $.$tdiv$n($.DateTime_DateTime$now().millisecondsSinceEpoch, msPerFrame);
    if (typeof t2 !== "number")
      throw t2.$mod();
    t3 = this.startCoordinate;
    t4 = this.nextDelta;
    $.CanvasUtil_drawImage(ctx, this._image, $.Box_Box$fromCoordSize(t3.$add(t3, t4.$mul(t4, $.JSNumber_methods.$mod(t2, t1))), this.get$size(this)), null);
  }
},

Stage: {"": "AttachableObject;_invalidatedEventHandle,_liblib1$_canvas<,rootThing<,_ctx,_propertyValues,_eventHandlers,_disposed",
  ...
  get$ctx: function() {
    this.validateNotDisposed$0();
    if (this._ctx == null)
      this._ctx = $.get$context2D$x(this._liblib1$_canvas);
    return this._ctx;
  },
  draw$0: function() {
    var t1, t2, t3;
...
MouseManager_setCursor: function(thing, value) {
  $.get$MouseManager_cursorProperty().set$2(thing, value);
},
...
SpriteThing$: function(image, width, height, startCoordinate, nextDelta, count) {
  return new $.SpriteThing(startCoordinate, nextDelta, count, 0, image, false, $.List_List(null), $.EventHandle$(null), null, width, height, 1, false, null, null, $.Map_Map(), $.Map_Map(), false);
},
...
_BroadcastStream: {"": "_StreamImpl;_liblib0$_controller",
  _createSubscription$4: function(onData, onError, onDone, cancelOnError) {
    return this._liblib0$_controller._subscribe$4(onData, onError, onDone, cancelOnError);
  }
},

_BroadcastSubscription: {"": "_ControllerSubscription;_eventState@,_next@,_previous@,_liblib0$_controller,_onData,_onError,_onDone,_zone,_state,_liblib0$_pending",
...
_BufferingStreamSubscription: {"": "Object;_onData,_onError,_onDone,_zone<,_state@,_liblib0$_pending",
  ...
  _cancel$0: function() {
    ...
    if (this.get$_hasPending())
      this._liblib0$_pending.cancelSchedule$0();
  },
  _liblib0$_add$1: function(data) {
    if (this.get$_isCanceled())
      return;
  ...
  _addPending$1: function($event) {
    var pending, t1;
    pending = this._liblib0$_pending;
    if (pending == null) {
      pending = new $._StreamImplEvents(null, null, 0);
      this._liblib0$_pending = pending;
    }
    pending.add$1;
    ...
    if ((t1 & 32) === 0) {
      this._state = (t1 | 32) >>> 0;
      if (this._state < 64)
        this._liblib0$_pending.schedule$1(this);
    }
  },
  _sendData$1: function(data) {
...
_ZoneBase: {"": "Object;",
  ...
  _checkIfDone$0: function() {
    if (!this._isExecutingCallback && this._openCallbacks === 0 && $.JSArray_methods.get$isEmpty(this._liblib0$_children))
      this._dispose$0();
  },
...
_DefaultZone: {"": "_ZoneBase;_parentZone,_liblib0$_children,_openCallbacks,_isExecutingCallback",
  get$_errorZone: function() {
    return this;
  },
  handleUncaughtError$1: function(error) {
...
_ZoneTimer: {"": "Object;_zone<,_liblib0$_callback,_timer",
  _run$0: function() {
    this._zone.executeCallbackGuarded$1(this._liblib0$_callback);
  },
  get$_run: function() {
...
LinkedHashMapCell: {"": "Object;_key<,_value@,_liblib$_next?,_liblib$_previous"},
  ...
  moveNext$0: function() {
    ...
    if (this._modifications !== t1._modifications)
      ...
      if (t1 == null) {
        ...
        this._cell = this._cell._liblib$_next;
        return true;
      }
    }
  },
...
_EventStream: {"": "Stream;_liblib4$_target,_eventType,_useCapture",
  listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
    return $._EventStreamSubscription$(this._liblib4$_target, this._eventType, onData, this._useCapture);
  },
  listen$1: function(onData) {
    return this.listen$4$cancelOnError$onDone$onError(onData, null, null, null);
  }
...
_EventStreamSubscription: {"": "StreamSubscription;_pauseCount,_liblib4$_target,_eventType,_liblib4$_onData,_useCapture",
  cancel$0: function() {
    if (this.get$_liblib4$_canceled())
      return;
    this._unlisten$0();
    this._liblib4$_target = null;
    this._liblib4$_onData = null;
  },
  get$_liblib4$_canceled: function() {
...
DraggerDemo: {"": "Object;_canvas,_stage,_tx,_demoMapper,_mouseLocation,_frameRequested,_thing",
  requestFrame$0: function() {
    if (!this._frameRequested) {
      ...
      $.Window_methods.requestAnimationFrame$1($.window(), this.get$_onFrame());
    }
  },
  ...
  DraggerDemo$_internal$4: function(_canvas, _stage, _tx, _thing) {
    var t1;
    this._demoMapper.get$outputChanged().listen$1(new $.DraggerDemo$_internal_closure(this));
    t1 = this._stage;
...
_demoIsolate_closure: {"": "Closure;",
  call$1: function(input) {
    ...
    otherMs = $.DateTime_DateTime$now().millisecondsSinceEpoch;
    ...
    } while ($.JSNumber_methods.$tdiv($.Duration$(0, 0, 0, $.$sub$n(t1.millisecondsSinceEpoch, otherMs), 0, 0)._duration, 1000000) < 1);
...
_DemoValue$: function() {
  return new $._DemoValue($.spawnFunction($._demoIsolate$closure, null), null, null, null, null, null, null, null, false, $.EventHandle$(null), $.EventHandle$(null), $.EventHandle$(null));
},
